...
from yt.funcs import (ensure_list, fix_axis, fix_length, iterable, mylog,
                      validate_3d_array, validate_axis, validate_center,
                      validate_float, validate_iterable, validate_object,
...
from yt.utilities.exceptions import (YTEllipsoidOrdering, YTException,
                                     YTIllDefinedCutRegion, YTSphereTooSmall)
...
class YTCuttingPlane(YTSelectionContainer2D):
    ...
    def to_pw(self, fields=None, center="c", width=None, axes_unit=None):
        ...
        from yt.visualization.plot_window import (
            PWViewerMPL, get_oblique_window_parameters)
