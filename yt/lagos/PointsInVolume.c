/* Generated by Cython 0.11.2 on Mon Aug 31 08:16:07 2009 */
...
/* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":33
...
static PyObject *__pyx_pf_2yt_5lagos_14PointsInVolume_PointsInVolume(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":40
 *                    float dx):
 ...
 */
  ...
  __pyx_t_1 = PyObject_GetAttr(__pyx_1, __pyx_kp_zeros); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 40; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":45
 *     cdef double dx_inv
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":46
 *     cdef unsigned int idx[3]
 *     count = 0
 *     dx_inv = 1.0 / dx             # <<<<<<<<<<<<<<
 *     for i in xrange(points.shape[0]):
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":47
 *     count = 0
 *     dx_inv = 1.0 / dx
 *     for i in xrange(points.shape[0]):             # <<<<<<<<<<<<<<
 *         if pmask[i] == 0:
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < (__pyx_v_points->dimensions[0]); __pyx_t_5+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":48
 *     dx_inv = 1.0 / dx
 *     for i in xrange(points.shape[0]):
 *         if pmask[i] == 0:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":49
 *     for i in xrange(points.shape[0]):
 *         if pmask[i] == 0:
 *             continue             # <<<<<<<<<<<<<<
 *         ex = 1
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":50
 *         if pmask[i] == 0:
 *             continue
 *         ex = 1             # <<<<<<<<<<<<<<
 *         for dim in xrange(3):
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":51
 *             continue
 *         ex = 1
 *         for dim in xrange(3):             # <<<<<<<<<<<<<<
 *             if points[i,dim] < left_edge[dim] or points[i,dim] > right_edge[dim]:
 ...
 */
    for (__pyx_t_8 = 0; __pyx_t_8 < 3; __pyx_t_8+=1) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":52
 *         ex = 1
 *         for dim in xrange(3):
 *             if points[i,dim] < left_edge[dim] or points[i,dim] > right_edge[dim]:             # <<<<<<<<<<<<<<
 *                 valid[i] = ex = 0
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":53
 *         for dim in xrange(3):
 *             if points[i,dim] < left_edge[dim] or points[i,dim] > right_edge[dim]:
 *                 valid[i] = ex = 0             # <<<<<<<<<<<<<<
 *                 break
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int8_t *, __pyx_bstruct_valid.buf, __pyx_t_15, __pyx_bstride_0_valid) = 0;
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":54
 *             if points[i,dim] < left_edge[dim] or points[i,dim] > right_edge[dim]:
 *                 valid[i] = ex = 0
 *                 break             # <<<<<<<<<<<<<<
 *         if ex == 1:
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":55
 *                 valid[i] = ex = 0
 *                 break
 *         if ex == 1:             # <<<<<<<<<<<<<<
 *             for dim in xrange(3):
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":56
 *                 break
 *         if ex == 1:
 *             for dim in xrange(3):             # <<<<<<<<<<<<<<
 *                 idx[dim] = <unsigned int> \
 ...
 */
      for (__pyx_t_8 = 0; __pyx_t_8 < 3; __pyx_t_8+=1) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":58
 *             for dim in xrange(3):
 *                 idx[dim] = <unsigned int> \
 *                            ((points[i,dim] - left_edge[dim]) * dx_inv)             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":57
 *         if ex == 1:
 *             for dim in xrange(3):
 *                 idx[dim] = <unsigned int> \             # <<<<<<<<<<<<<<
 *                            ((points[i,dim] - left_edge[dim]) * dx_inv)
 ...
 */
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":59
 *                 idx[dim] = <unsigned int> \
 *                            ((points[i,dim] - left_edge[dim]) * dx_inv)
 *             if mask[idx[0], idx[1], idx[2]] == 1:             # <<<<<<<<<<<<<<
 *                 valid[i] = 1
 ...
 */
      ...
      if (__pyx_t_7) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":60
 *                            ((points[i,dim] - left_edge[dim]) * dx_inv)
 *             if mask[idx[0], idx[1], idx[2]] == 1:
 *                 valid[i] = 1             # <<<<<<<<<<<<<<
 *                 count += 1
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int8_t *, __pyx_bstruct_valid.buf, __pyx_t_8, __pyx_bstride_0_valid) = 1;
        ...
        /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":61
 *             if mask[idx[0], idx[1], idx[2]] == 1:
 *                 valid[i] = 1
 *                 count += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":63
 *                 count += 1
 * 
 *     cdef np.ndarray[np.int32_t, ndim=1] result = np.empty(count, dtype='int32')             # <<<<<<<<<<<<<<
 *     count = 0
 *     for i in xrange(points.shape[0]):
 */
  __pyx_1 = __Pyx_GetName(__pyx_m, __pyx_kp_np); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_1);
  __pyx_t_2 = PyObject_GetAttr(__pyx_1, __pyx_kp_empty); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_t_3 = PyInt_FromLong(__pyx_v_count); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GOTREF(((PyObject *)__pyx_1));
  if (PyDict_SetItem(__pyx_1, __pyx_kp_dtype, __pyx_kp_32) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = PyEval_CallObjectWithKeywords(__pyx_t_2, ((PyObject *)__pyx_t_1), ((PyObject *)__pyx_1)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_1)); __pyx_1 = 0;
  if (!(__Pyx_TypeTest(__pyx_t_3, __pyx_ptype_5numpy_ndarray))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 63; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":64
 * 
 *     cdef np.ndarray[np.int32_t, ndim=1] result = np.empty(count, dtype='int32')
 *     count = 0             # <<<<<<<<<<<<<<
 *     for i in xrange(points.shape[0]):
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":65
 *     cdef np.ndarray[np.int32_t, ndim=1] result = np.empty(count, dtype='int32')
 *     count = 0
 *     for i in xrange(points.shape[0]):             # <<<<<<<<<<<<<<
 *         if valid[i] == 1 and pmask[i] == 1:
 ...
 */
  for (__pyx_t_5 = 0; __pyx_t_5 < (__pyx_v_points->dimensions[0]); __pyx_t_5+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":66
 *     count = 0
 *     for i in xrange(points.shape[0]):
 *         if valid[i] == 1 and pmask[i] == 1:             # <<<<<<<<<<<<<<
 *             result[count] = i
 ...
 */
    ...
    if (__pyx_t_7) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":67
 *     for i in xrange(points.shape[0]):
 *         if valid[i] == 1 and pmask[i] == 1:
 *             result[count] = i             # <<<<<<<<<<<<<<
 *             count += 1
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int32_t *, __pyx_bstruct_result.buf, __pyx_t_25, __pyx_bstride_0_result) = __pyx_v_i;
      ...
      /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":68
 *         if valid[i] == 1 and pmask[i] == 1:
 *             result[count] = i
 *             count += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":70
 *             count += 1
 * 
 *     return result             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  /* "/Users/matthewturk/yt/yt/yt/lagos/PointsInVolume.pyx":27
 * 
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
