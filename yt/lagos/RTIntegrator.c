/* Generated by Cython 0.11.2 on Fri Aug 28 15:21:41 2009 */
...
/* "yt/yt/lagos/RTIntegrator.pyx":32
 * 
...
static PyObject *__pyx_pf_2yt_5lagos_12RTIntegrator_Transfer3D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":51
 *     cdef int k, kk
 *     cdef int n, nn
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":52
 *     cdef int n, nn
 *     nn = o_s.shape[3] # This might be slow
 *     cdef np.float64_t *temp = <np.float64_t *>malloc(sizeof(np.float64_t) * nn)             # <<<<<<<<<<<<<<
 *     for i in range((imax-imin)*istride):
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":53
 *     nn = o_s.shape[3] # This might be slow
 *     cdef np.float64_t *temp = <np.float64_t *>malloc(sizeof(np.float64_t) * nn)
 *     for i in range((imax-imin)*istride):             # <<<<<<<<<<<<<<
 *         ii = i + imin*istride
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < ((__pyx_v_imax - __pyx_v_imin) * __pyx_v_istride); __pyx_t_1+=1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":54
 *     cdef np.float64_t *temp = <np.float64_t *>malloc(sizeof(np.float64_t) * nn)
 *     for i in range((imax-imin)*istride):
 *         ii = i + imin*istride             # <<<<<<<<<<<<<<
 *         for j in range((jmax-jmin)*jstride):
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":55
 *     for i in range((imax-imin)*istride):
 *         ii = i + imin*istride
 *         for j in range((jmax-jmin)*jstride):             # <<<<<<<<<<<<<<
 *             jj = j + jmin*jstride
 ...
 */
    for (__pyx_t_2 = 0; __pyx_t_2 < ((__pyx_v_jmax - __pyx_v_jmin) * __pyx_v_jstride); __pyx_t_2+=1) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":56
 *         ii = i + imin*istride
 *         for j in range((jmax-jmin)*jstride):
 *             jj = j + jmin*jstride             # <<<<<<<<<<<<<<
 *             # Not sure about the ordering of the loops here
 ...
 */
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":58
 *             jj = j + jmin*jstride
 *             # Not sure about the ordering of the loops here
 *             for n in range(nn):             # <<<<<<<<<<<<<<
 *                 temp[n] = i_s[ii,jj,n]
 ...
 */
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_v_nn; __pyx_t_3+=1) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":59
 *             # Not sure about the ordering of the loops here
 *             for n in range(nn):
 *                 temp[n] = i_s[ii,jj,n]             # <<<<<<<<<<<<<<
 *             for k in range(kmax-kmin):
 ...
 */
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":60
 *             for n in range(nn):
 *                 temp[n] = i_s[ii,jj,n]
 *             for k in range(kmax-kmin):             # <<<<<<<<<<<<<<
 *                 kk = k + kmin#*kstride, which doesn't make any sense
 ...
 */
      for (__pyx_t_3 = 0; __pyx_t_3 < (__pyx_v_kmax - __pyx_v_kmin); __pyx_t_3+=1) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":61
 *                 temp[n] = i_s[ii,jj,n]
 *             for k in range(kmax-kmin):
 *                 kk = k + kmin#*kstride, which doesn't make any sense             # <<<<<<<<<<<<<<
 *                 for n in range(nn):
 ...
 */
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":62
 *             for k in range(kmax-kmin):
 *                 kk = k + kmin#*kstride, which doesn't make any sense
 *                 for n in range(nn):             # <<<<<<<<<<<<<<
 *                     o_s[i,j,k,n] = temp[n] + dx*(e[i,j,k,n] - temp[n]*a[i,j,k,n])
 ...
 */
        for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_v_nn; __pyx_t_7+=1) {
          ...
          /* "yt/yt/lagos/RTIntegrator.pyx":63
 *                 kk = k + kmin#*kstride, which doesn't make any sense
 *                 for n in range(nn):
 *                     o_s[i,j,k,n] = temp[n] + dx*(e[i,j,k,n] - temp[n]*a[i,j,k,n])             # <<<<<<<<<<<<<<
 *                     temp[n] = o_s[i,j,k,n]
 ...
 */
          ...
          *__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_o_s.buf, __pyx_t_16, __pyx_bstride_0_o_s, __pyx_t_17, __pyx_bstride_1_o_s, __pyx_t_18, __pyx_bstride_2_o_s, __pyx_t_19, __pyx_bstride_3_o_s) = ((__pyx_v_temp[__pyx_v_n]) + (__pyx_v_dx * ((*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_e.buf, __pyx_t_8, __pyx_bstride_0_e, __pyx_t_9, __pyx_bstride_1_e, __pyx_t_10, __pyx_bstride_2_e, __pyx_t_11, __pyx_bstride_3_e)) - ((__pyx_v_temp[__pyx_v_n]) * (*__Pyx_BufPtrStrided4d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_a.buf, __pyx_t_12, __pyx_bstride_0_a, __pyx_t_13, __pyx_bstride_1_a, __pyx_t_14, __pyx_bstride_2_a, __pyx_t_15, __pyx_bstride_3_a))))));
          ...
          /* "yt/yt/lagos/RTIntegrator.pyx":64
 *                 for n in range(nn):
 *                     o_s[i,j,k,n] = temp[n] + dx*(e[i,j,k,n] - temp[n]*a[i,j,k,n])
 *                     temp[n] = o_s[i,j,k,n]             # <<<<<<<<<<<<<<
 *             for n in range(nn):
 ...
 */
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":65
 *                     o_s[i,j,k,n] = temp[n] + dx*(e[i,j,k,n] - temp[n]*a[i,j,k,n])
 *                     temp[n] = o_s[i,j,k,n]
 *             for n in range(nn):             # <<<<<<<<<<<<<<
 *                 i_s[ii,jj,n] = temp[n]
 ...
 */
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_v_nn; __pyx_t_3+=1) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":66
 *                     temp[n] = o_s[i,j,k,n]
 *             for n in range(nn):
 *                 i_s[ii,jj,n] = temp[n]             # <<<<<<<<<<<<<<
 *     free(temp)
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":67
 *             for n in range(nn):
 *                 i_s[ii,jj,n] = temp[n]
 *     free(temp)             # <<<<<<<<<<<<<<
 * 
...
/* "yt/yt/lagos/RTIntegrator.pyx":70
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_2yt_5lagos_12RTIntegrator_TransferShells(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":82
 *     cdef int n, nn
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":83
 *     cdef np.float64_t dist
 *     ii = data.shape[0]
 *     jj = data.shape[1]             # <<<<<<<<<<<<<<
 *     kk = data.shape[2]
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":84
 *     ii = data.shape[0]
 *     jj = data.shape[1]
 *     kk = data.shape[2]             # <<<<<<<<<<<<<<
 *     nn = shells.shape[0]
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":85
 *     jj = data.shape[1]
 *     kk = data.shape[2]
 *     nn = shells.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(ii):
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":86
 *     kk = data.shape[2]
 *     nn = shells.shape[0]
 *     for i in range(ii):             # <<<<<<<<<<<<<<
 *         for j in range(jj):
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_v_ii; __pyx_t_1+=1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":87
 *     nn = shells.shape[0]
 *     for i in range(ii):
 *         for j in range(jj):             # <<<<<<<<<<<<<<
 *             # Not sure about the ordering of the loops here
 ...
 */
    for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_v_jj; __pyx_t_2+=1) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":89
 *         for j in range(jj):
 *             # Not sure about the ordering of the loops here
 *             for k in range(kk):             # <<<<<<<<<<<<<<
 *                 for n in range(nn):
 ...
 */
      for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_v_kk; __pyx_t_3+=1) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":90
 *             # Not sure about the ordering of the loops here
 *             for k in range(kk):
 *                 for n in range(nn):             # <<<<<<<<<<<<<<
 *                     dist = shells[n, 0] - data[i,j,k]
 ...
 */
        for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_v_nn; __pyx_t_4+=1) {
          ...
          /* "yt/yt/lagos/RTIntegrator.pyx":91
 *             for k in range(kk):
 *                 for n in range(nn):
 *                     dist = shells[n, 0] - data[i,j,k]             # <<<<<<<<<<<<<<
 *                     if dist < 0: dist *= -1.0
 ...
 */
          ...
          /* "yt/yt/lagos/RTIntegrator.pyx":92
 *                 for n in range(nn):
 *                     dist = shells[n, 0] - data[i,j,k]
 *                     if dist < 0: dist *= -1.0             # <<<<<<<<<<<<<<
 *                     if dist < shells[n,1]:
 ...
 */
          ...
          /* "yt/yt/lagos/RTIntegrator.pyx":93
 *                     dist = shells[n, 0] - data[i,j,k]
 *                     if dist < 0: dist *= -1.0
 *                     if dist < shells[n,1]:             # <<<<<<<<<<<<<<
 *                         #dist *= dist
 ...
 */
          ...
          if (__pyx_t_10) {
            ...
            /* "yt/yt/lagos/RTIntegrator.pyx":95
 *                     if dist < shells[n,1]:
 *                         #dist *= dist
 *                         i_s[i,j,0] += shells[n,2]*dist             # <<<<<<<<<<<<<<
 ...
 */
            ...
            *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_i_s.buf, __pyx_t_15, __pyx_bstride_0_i_s, __pyx_t_16, __pyx_bstride_1_i_s, __pyx_t_17, __pyx_bstride_2_i_s) += ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_shells.buf, __pyx_t_13, __pyx_bstride_0_shells, __pyx_t_14, __pyx_bstride_1_shells)) * __pyx_v_dist);
            ...
            /* "yt/yt/lagos/RTIntegrator.pyx":96
 *                         #dist *= dist
 *                         i_s[i,j,0] += shells[n,2]*dist
 *                         i_s[i,j,1] += shells[n,3]*dist             # <<<<<<<<<<<<<<
 *                         i_s[i,j,2] += shells[n,4]*dist
 ...
 */
            ...
            *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_i_s.buf, __pyx_t_20, __pyx_bstride_0_i_s, __pyx_t_21, __pyx_bstride_1_i_s, __pyx_t_22, __pyx_bstride_2_i_s) += ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_shells.buf, __pyx_t_18, __pyx_bstride_0_shells, __pyx_t_19, __pyx_bstride_1_shells)) * __pyx_v_dist);
            ...
            /* "yt/yt/lagos/RTIntegrator.pyx":97
 *                         i_s[i,j,0] += shells[n,2]*dist
 *                         i_s[i,j,1] += shells[n,3]*dist
 *                         i_s[i,j,2] += shells[n,4]*dist             # <<<<<<<<<<<<<<
 *                         break
 ...
 */
            ...
            *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_i_s.buf, __pyx_t_25, __pyx_bstride_0_i_s, __pyx_t_26, __pyx_bstride_1_i_s, __pyx_t_27, __pyx_bstride_2_i_s) += ((*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_shells.buf, __pyx_t_23, __pyx_bstride_0_shells, __pyx_t_24, __pyx_bstride_1_shells)) * __pyx_v_dist);
            ...
            /* "yt/yt/lagos/RTIntegrator.pyx":98
 *                         i_s[i,j,1] += shells[n,3]*dist
 *                         i_s[i,j,2] += shells[n,4]*dist
 *                         break             # <<<<<<<<<<<<<<
 * 
...
/* "yt/yt/lagos/RTIntegrator.pyx":101
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_2yt_5lagos_12RTIntegrator_Transfer1D(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":108
 *                int imin, int imax):
 *     cdef int i
 ...
 */
  for (__pyx_t_1 = __pyx_v_imin; __pyx_t_1 < __pyx_v_imax; __pyx_t_1+=1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":109
 *     cdef int i
 *     for i in range(imin, imax):
 *         o_s[i] = i_s + dx[i]*(e[i] - i_s*a[i])             # <<<<<<<<<<<<<<
 *         i_s = o_s[i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_bstruct_o_s.buf, __pyx_t_5, __pyx_bstride_0_o_s) = (__pyx_v_i_s + ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_bstruct_dx.buf, __pyx_t_2, __pyx_bstride_0_dx)) * ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_bstruct_e.buf, __pyx_t_3, __pyx_bstride_0_e)) - (__pyx_v_i_s * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_bstruct_a.buf, __pyx_t_4, __pyx_bstride_0_a))))));
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":110
 *     for i in range(imin, imax):
 *         o_s[i] = i_s + dx[i]*(e[i] - i_s*a[i])
 *         i_s = o_s[i]             # <<<<<<<<<<<<<<
 *     return i_s
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":111
 *         o_s[i] = i_s + dx[i]*(e[i] - i_s*a[i])
 *         i_s = o_s[i]
 *     return i_s             # <<<<<<<<<<<<<<
 * 
...
/* "yt/yt/lagos/RTIntegrator.pyx":115
 * @cython.wraparound(False)
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pf_2yt_5lagos_12RTIntegrator_VoxelTraversal(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":128
 *     cdef int i, x, y
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":129
 *     cdef np.float64_t tl, tr, intersect_t, enter_t, exit_t, dt_tolerance
 *     cdef np.ndarray[np.int64_t,   ndim=1] step = np.empty((3,), dtype=np.int64)
 *     cdef np.ndarray[np.int64_t,   ndim=1] cur_ind = np.empty((3,), dtype=np.int64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float64_t, ndim=1] tdelta = np.empty((3,), dtype=np.float64)
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":130
 *     cdef np.ndarray[np.int64_t,   ndim=1] step = np.empty((3,), dtype=np.int64)
 *     cdef np.ndarray[np.int64_t,   ndim=1] cur_ind = np.empty((3,), dtype=np.int64)
 *     cdef np.ndarray[np.float64_t, ndim=1] tdelta = np.empty((3,), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float64_t, ndim=1] tmax = np.empty((3,), dtype=np.float64)
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":131
 *     cdef np.ndarray[np.int64_t,   ndim=1] cur_ind = np.empty((3,), dtype=np.int64)
 *     cdef np.ndarray[np.float64_t, ndim=1] tdelta = np.empty((3,), dtype=np.float64)
 *     cdef np.ndarray[np.float64_t, ndim=1] tmax = np.empty((3,), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float64_t, ndim=1] intersect = np.empty((3,), dtype=np.float64)
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":132
 *     cdef np.ndarray[np.float64_t, ndim=1] tdelta = np.empty((3,), dtype=np.float64)
 *     cdef np.ndarray[np.float64_t, ndim=1] tmax = np.empty((3,), dtype=np.float64)
 *     cdef np.ndarray[np.float64_t, ndim=1] intersect = np.empty((3,), dtype=np.float64)             # <<<<<<<<<<<<<<
 *     intersect_t = 1
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":133
 *     cdef np.ndarray[np.float64_t, ndim=1] tmax = np.empty((3,), dtype=np.float64)
 *     cdef np.ndarray[np.float64_t, ndim=1] intersect = np.empty((3,), dtype=np.float64)
 *     intersect_t = 1             # <<<<<<<<<<<<<<
 *     dt_tolerance = 1e-6
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":134
 *     cdef np.ndarray[np.float64_t, ndim=1] intersect = np.empty((3,), dtype=np.float64)
 *     intersect_t = 1
 *     dt_tolerance = 1e-6             # <<<<<<<<<<<<<<
 *     # recall p = v * t + u
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":137
 *     # recall p = v * t + u
 *     #  where p is position, v is our vector, u is the start point
 *     for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_9 = 0; __pyx_t_9 < 3; __pyx_t_9+=1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":139
 *     for i in range(3):
 *         # As long as we're iterating, set some other stuff, too
 *         if(v[i] < 0): step[i] = -1             # <<<<<<<<<<<<<<
 *         else: step[i] = 1
 ...
 */
    ...
    /*else*/ {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":140
 *         # As long as we're iterating, set some other stuff, too
 *         if(v[i] < 0): step[i] = -1
 *         else: step[i] = 1             # <<<<<<<<<<<<<<
 *         x = (i+1)%3
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":141
 *         if(v[i] < 0): step[i] = -1
 *         else: step[i] = 1
 *         x = (i+1)%3             # <<<<<<<<<<<<<<
 *         y = (i+2)%3
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":142
 *         else: step[i] = 1
 *         x = (i+1)%3
 *         y = (i+2)%3             # <<<<<<<<<<<<<<
 *         tl = (left_edge[i] - u[i])/v[i]
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":143
 *         x = (i+1)%3
 *         y = (i+2)%3
 *         tl = (left_edge[i] - u[i])/v[i]             # <<<<<<<<<<<<<<
 *         tr = (right_edge[i] - u[i])/v[i]
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":144
 *         y = (i+2)%3
 *         tl = (left_edge[i] - u[i])/v[i]
 *         tr = (right_edge[i] - u[i])/v[i]             # <<<<<<<<<<<<<<
 *         if (left_edge[x] <= (u[x] + tl*v[x]) <= right_edge[x]) and \
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":145
 *         tl = (left_edge[i] - u[i])/v[i]
 *         tr = (right_edge[i] - u[i])/v[i]
 *         if (left_edge[x] <= (u[x] + tl*v[x]) <= right_edge[x]) and \             # <<<<<<<<<<<<<<
 *            (left_edge[y] <= (u[y] + tl*v[y]) <= right_edge[y]) and \
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":146
 *         tr = (right_edge[i] - u[i])/v[i]
 *         if (left_edge[x] <= (u[x] + tl*v[x]) <= right_edge[x]) and \
 *            (left_edge[y] <= (u[y] + tl*v[y]) <= right_edge[y]) and \             # <<<<<<<<<<<<<<
 *            (0.0 <= tl < intersect_t):
 ...
 */
      ...
      if (__pyx_t_28) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":147
 *         if (left_edge[x] <= (u[x] + tl*v[x]) <= right_edge[x]) and \
 *            (left_edge[y] <= (u[y] + tl*v[y]) <= right_edge[y]) and \
 *            (0.0 <= tl < intersect_t):             # <<<<<<<<<<<<<<
 *             intersect_t = tl
 ...
 */
    ...
    if (__pyx_t_28) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":148
 *            (left_edge[y] <= (u[y] + tl*v[y]) <= right_edge[y]) and \
 *            (0.0 <= tl < intersect_t):
 *             intersect_t = tl             # <<<<<<<<<<<<<<
 *         if (left_edge[x] <= (u[x] + tr*v[x]) <= right_edge[x]) and \
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":149
 *            (0.0 <= tl < intersect_t):
 *             intersect_t = tl
 *         if (left_edge[x] <= (u[x] + tr*v[x]) <= right_edge[x]) and \             # <<<<<<<<<<<<<<
 *            (left_edge[y] <= (u[y] + tr*v[y]) <= right_edge[y]) and \
 ...
 */
    ...
    if (__pyx_t_28) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":150
 *             intersect_t = tl
 *         if (left_edge[x] <= (u[x] + tr*v[x]) <= right_edge[x]) and \
 *            (left_edge[y] <= (u[y] + tr*v[y]) <= right_edge[y]) and \             # <<<<<<<<<<<<<<
 *            (0.0 <= tr < intersect_t):
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":151
 *         if (left_edge[x] <= (u[x] + tr*v[x]) <= right_edge[x]) and \
 *            (left_edge[y] <= (u[y] + tr*v[y]) <= right_edge[y]) and \
 *            (0.0 <= tr < intersect_t):             # <<<<<<<<<<<<<<
 *             intersect_t = tr
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":152
 *            (left_edge[y] <= (u[y] + tr*v[y]) <= right_edge[y]) and \
 *            (0.0 <= tr < intersect_t):
 *             intersect_t = tr             # <<<<<<<<<<<<<<
 *     # if fully enclosed
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":154
 *             intersect_t = tr
 *     # if fully enclosed
 *     if (left_edge[0] <= u[0] <= right_edge[0]) and \             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_11) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":155
 *     # if fully enclosed
 *     if (left_edge[0] <= u[0] <= right_edge[0]) and \
 *        (left_edge[1] <= u[1] <= right_edge[1]) and \             # <<<<<<<<<<<<<<
 *        (left_edge[2] <= u[2] <= right_edge[2]):
 ...
 */
    ...
    if (__pyx_t_28) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":156
 *     if (left_edge[0] <= u[0] <= right_edge[0]) and \
 *        (left_edge[1] <= u[1] <= right_edge[1]) and \
 *        (left_edge[2] <= u[2] <= right_edge[2]):             # <<<<<<<<<<<<<<
 *         intersect_t = 0.0
 ...
 */
  ...
  if (__pyx_t_28) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":157
 *        (left_edge[1] <= u[1] <= right_edge[1]) and \
 *        (left_edge[2] <= u[2] <= right_edge[2]):
 *         intersect_t = 0.0             # <<<<<<<<<<<<<<
 *     if not (0 <= intersect_t <= 1): return
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":158
 *        (left_edge[2] <= u[2] <= right_edge[2]):
 *         intersect_t = 0.0
 *     if not (0 <= intersect_t <= 1): return             # <<<<<<<<<<<<<<
 *     # Now get the indices of the intersection
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":160
 *     if not (0 <= intersect_t <= 1): return
 *     # Now get the indices of the intersection
 *     intersect = u + intersect_t * v             # <<<<<<<<<<<<<<
 *     cdef int ncells = 0
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":161
 *     # Now get the indices of the intersection
 *     intersect = u + intersect_t * v
 *     cdef int ncells = 0             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":162
 *     intersect = u + intersect_t * v
 *     cdef int ncells = 0
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         cur_ind[i] = np.floor((intersect[i] + 1e-8*dx[i] - left_edge[i])/dx[i])
 ...
 */
  for (__pyx_t_9 = 0; __pyx_t_9 < 3; __pyx_t_9+=1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":163
 *     cdef int ncells = 0
 *     for i in range(3):
 *         cur_ind[i] = np.floor((intersect[i] + 1e-8*dx[i] - left_edge[i])/dx[i])             # <<<<<<<<<<<<<<
 *         tmax[i] = (((cur_ind[i]+step[i])*dx[i])+left_edge[i]-u[i])/v[i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_cur_ind.buf, __pyx_t_57, __pyx_bstride_0_cur_ind) = __pyx_t_56;
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":164
 *     for i in range(3):
 *         cur_ind[i] = np.floor((intersect[i] + 1e-8*dx[i] - left_edge[i])/dx[i])
 *         tmax[i] = (((cur_ind[i]+step[i])*dx[i])+left_edge[i]-u[i])/v[i]             # <<<<<<<<<<<<<<
 *         if cur_ind[i] == grid_mask.shape[i] and step[i] < 0:
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_64, __pyx_bstride_0_tmax) = ((((((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_cur_ind.buf, __pyx_t_58, __pyx_bstride_0_cur_ind)) + (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_step.buf, __pyx_t_59, __pyx_bstride_0_step))) * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_dx.buf, __pyx_t_60, __pyx_bstride_0_dx))) + (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_left_edge.buf, __pyx_t_61, __pyx_bstride_0_left_edge))) - (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_u.buf, __pyx_t_62, __pyx_bstride_0_u))) / (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_v.buf, __pyx_t_63, __pyx_bstride_0_v)));
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":165
 *         cur_ind[i] = np.floor((intersect[i] + 1e-8*dx[i] - left_edge[i])/dx[i])
 *         tmax[i] = (((cur_ind[i]+step[i])*dx[i])+left_edge[i]-u[i])/v[i]
 *         if cur_ind[i] == grid_mask.shape[i] and step[i] < 0:             # <<<<<<<<<<<<<<
 *             cur_ind[i] = grid_mask.shape[i] - 1
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":166
 *         tmax[i] = (((cur_ind[i]+step[i])*dx[i])+left_edge[i]-u[i])/v[i]
 *         if cur_ind[i] == grid_mask.shape[i] and step[i] < 0:
 *             cur_ind[i] = grid_mask.shape[i] - 1             # <<<<<<<<<<<<<<
 *         if step[i] > 0: tmax[i] = (((cur_ind[i]+1)*dx[i])+left_edge[i]-u[i])/v[i]
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":167
 *         if cur_ind[i] == grid_mask.shape[i] and step[i] < 0:
 *             cur_ind[i] = grid_mask.shape[i] - 1
 *         if step[i] > 0: tmax[i] = (((cur_ind[i]+1)*dx[i])+left_edge[i]-u[i])/v[i]             # <<<<<<<<<<<<<<
 *         if step[i] < 0: tmax[i] = (((cur_ind[i]+0)*dx[i])+left_edge[i]-u[i])/v[i]
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":168
 *             cur_ind[i] = grid_mask.shape[i] - 1
 *         if step[i] > 0: tmax[i] = (((cur_ind[i]+1)*dx[i])+left_edge[i]-u[i])/v[i]
 *         if step[i] < 0: tmax[i] = (((cur_ind[i]+0)*dx[i])+left_edge[i]-u[i])/v[i]             # <<<<<<<<<<<<<<
 *         tdelta[i] = np.abs((dx[i]/v[i]))
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":169
 *         if step[i] > 0: tmax[i] = (((cur_ind[i]+1)*dx[i])+left_edge[i]-u[i])/v[i]
 *         if step[i] < 0: tmax[i] = (((cur_ind[i]+0)*dx[i])+left_edge[i]-u[i])/v[i]
 *         tdelta[i] = np.abs((dx[i]/v[i]))             # <<<<<<<<<<<<<<
 *     # The variable intersect contains the point we first pierce the grid
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":171
 *         tdelta[i] = np.abs((dx[i]/v[i]))
 *     # The variable intersect contains the point we first pierce the grid
 *     enter_t = intersect_t             # <<<<<<<<<<<<<<
 *     while 1:
 ...
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":172
 *     # The variable intersect contains the point we first pierce the grid
 *     enter_t = intersect_t
 *     while 1:             # <<<<<<<<<<<<<<
 *         if (not (0 <= cur_ind[0] < grid_mask.shape[0])) or \
 ...
 */
  while (1) {
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":173
 *     enter_t = intersect_t
 *     while 1:
 *         if (not (0 <= cur_ind[0] < grid_mask.shape[0])) or \             # <<<<<<<<<<<<<<
 *            (not (0 <= cur_ind[1] < grid_mask.shape[1])) or \
 ...
 */
    ...
    if (!(!__pyx_t_11)) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":174
 *     while 1:
 *         if (not (0 <= cur_ind[0] < grid_mask.shape[0])) or \
 *            (not (0 <= cur_ind[1] < grid_mask.shape[1])) or \             # <<<<<<<<<<<<<<
 *            (not (0 <= cur_ind[2] < grid_mask.shape[2])):
 ...
 */
      ...
      if (!(!__pyx_t_28)) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":175
 *         if (not (0 <= cur_ind[0] < grid_mask.shape[0])) or \
 *            (not (0 <= cur_ind[1] < grid_mask.shape[1])) or \
 *            (not (0 <= cur_ind[2] < grid_mask.shape[2])):             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    ...
    if (__pyx_t_28) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":176
 *            (not (0 <= cur_ind[1] < grid_mask.shape[1])) or \
 *            (not (0 <= cur_ind[2] < grid_mask.shape[2])):
 *             break             # <<<<<<<<<<<<<<
 *         # Note that we are calculating t on the fly, but we get *negative* t
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":180
 *         # values from what they should be.
 ...
 */
    ...
    *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_int_t *, __pyx_bstruct_grid_mask.buf, __pyx_t_56, __pyx_bstride_0_grid_mask, __pyx_t_91, __pyx_bstride_1_grid_mask, __pyx_t_92, __pyx_bstride_2_grid_mask) = 1;
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":181
 *         # If we've reached t = 1, we are done.
 *         grid_mask[cur_ind[0], cur_ind[1], cur_ind[2]] = 1
 *         if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):             # <<<<<<<<<<<<<<
 *             grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = 1.0 - enter_t
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":182
 *         grid_mask[cur_ind[0], cur_ind[1], cur_ind[2]] = 1
 *         if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):
 *             grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = 1.0 - enter_t             # <<<<<<<<<<<<<<
 *             break
 ...
 */
      ...
      *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_dt.buf, __pyx_t_99, __pyx_bstride_0_grid_dt, __pyx_t_100, __pyx_bstride_1_grid_dt, __pyx_t_101, __pyx_bstride_2_grid_dt) = (1.0 - __pyx_v_enter_t);
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":183
 *         if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):
 *             grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = 1.0 - enter_t
 *             break             # <<<<<<<<<<<<<<
 *         ncells += 1
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":184
 *             grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = 1.0 - enter_t
 *             break
 *         ncells += 1             # <<<<<<<<<<<<<<
 *         if tmax[0] < tmax[1]:
 ...
 */
    ...
    /* "yt/yt/lagos/RTIntegrator.pyx":185
 *             break
 *         ncells += 1
 *         if tmax[0] < tmax[1]:             # <<<<<<<<<<<<<<
 *             if tmax[0] < tmax[2]:
 ...
 */
    ...
    if (__pyx_t_11) {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":186
 *         ncells += 1
 *         if tmax[0] < tmax[1]:
 *             if tmax[0] < tmax[2]:             # <<<<<<<<<<<<<<
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":187
 *         if tmax[0] < tmax[1]:
 *             if tmax[0] < tmax[2]:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t             # <<<<<<<<<<<<<<
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[0] - enter_t
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_t.buf, __pyx_t_109, __pyx_bstride_0_grid_t, __pyx_t_110, __pyx_bstride_1_grid_t, __pyx_t_111, __pyx_bstride_2_grid_t) = __pyx_v_enter_t;
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":188
 *             if tmax[0] < tmax[2]:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[0] - enter_t             # <<<<<<<<<<<<<<
 *                 enter_t = tmax[0]
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_dt.buf, __pyx_t_116, __pyx_bstride_0_grid_dt, __pyx_t_117, __pyx_bstride_1_grid_dt, __pyx_t_118, __pyx_bstride_2_grid_dt) = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_112, __pyx_bstride_0_tmax)) - __pyx_v_enter_t);
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":189
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[0] - enter_t
 *                 enter_t = tmax[0]             # <<<<<<<<<<<<<<
 *                 tmax[0] += tdelta[0]
 ...
 */
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":190
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[0] - enter_t
 *                 enter_t = tmax[0]
 *                 tmax[0] += tdelta[0]             # <<<<<<<<<<<<<<
 *                 cur_ind[0] += step[0]
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_121, __pyx_bstride_0_tmax) += (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tdelta.buf, __pyx_t_120, __pyx_bstride_0_tdelta));
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":191
 *                 enter_t = tmax[0]
 *                 tmax[0] += tdelta[0]
 *                 cur_ind[0] += step[0]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":193
 *                 cur_ind[0] += step[0]
 *             else:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t             # <<<<<<<<<<<<<<
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_t.buf, __pyx_t_127, __pyx_bstride_0_grid_t, __pyx_t_128, __pyx_bstride_1_grid_t, __pyx_t_129, __pyx_bstride_2_grid_t) = __pyx_v_enter_t;
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":194
 *             else:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t             # <<<<<<<<<<<<<<
 *                 enter_t = tmax[2]
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_dt.buf, __pyx_t_134, __pyx_bstride_0_grid_dt, __pyx_t_135, __pyx_bstride_1_grid_dt, __pyx_t_136, __pyx_bstride_2_grid_dt) = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_130, __pyx_bstride_0_tmax)) - __pyx_v_enter_t);
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":195
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t
 *                 enter_t = tmax[2]             # <<<<<<<<<<<<<<
 *                 tmax[2] += tdelta[2]
 ...
 */
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":196
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t
 *                 enter_t = tmax[2]
 *                 tmax[2] += tdelta[2]             # <<<<<<<<<<<<<<
 *                 cur_ind[2] += step[2]
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_139, __pyx_bstride_0_tmax) += (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tdelta.buf, __pyx_t_138, __pyx_bstride_0_tdelta));
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":197
 *                 enter_t = tmax[2]
 *                 tmax[2] += tdelta[2]
 *                 cur_ind[2] += step[2]             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "yt/yt/lagos/RTIntegrator.pyx":199
 *                 cur_ind[2] += step[2]
 *         else:
 *             if tmax[1] < tmax[2]:             # <<<<<<<<<<<<<<
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 ...
 */
      ...
      if (__pyx_t_11) {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":200
 *         else:
 *             if tmax[1] < tmax[2]:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t             # <<<<<<<<<<<<<<
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[1] - enter_t
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_t.buf, __pyx_t_147, __pyx_bstride_0_grid_t, __pyx_t_148, __pyx_bstride_1_grid_t, __pyx_t_149, __pyx_bstride_2_grid_t) = __pyx_v_enter_t;
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":201
 *             if tmax[1] < tmax[2]:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[1] - enter_t             # <<<<<<<<<<<<<<
 *                 enter_t = tmax[1]
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_dt.buf, __pyx_t_154, __pyx_bstride_0_grid_dt, __pyx_t_155, __pyx_bstride_1_grid_dt, __pyx_t_156, __pyx_bstride_2_grid_dt) = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_150, __pyx_bstride_0_tmax)) - __pyx_v_enter_t);
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":202
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[1] - enter_t
 *                 enter_t = tmax[1]             # <<<<<<<<<<<<<<
 *                 tmax[1] += tdelta[1]
 ...
 */
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":203
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[1] - enter_t
 *                 enter_t = tmax[1]
 *                 tmax[1] += tdelta[1]             # <<<<<<<<<<<<<<
 *                 cur_ind[1] += step[1]
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_159, __pyx_bstride_0_tmax) += (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tdelta.buf, __pyx_t_158, __pyx_bstride_0_tdelta));
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":204
 *                 enter_t = tmax[1]
 *                 tmax[1] += tdelta[1]
 *                 cur_ind[1] += step[1]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":206
 *                 cur_ind[1] += step[1]
 *             else:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t             # <<<<<<<<<<<<<<
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_t.buf, __pyx_t_165, __pyx_bstride_0_grid_t, __pyx_t_166, __pyx_bstride_1_grid_t, __pyx_t_167, __pyx_bstride_2_grid_t) = __pyx_v_enter_t;
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":207
 *             else:
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t             # <<<<<<<<<<<<<<
 *                 enter_t = tmax[2]
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_grid_dt.buf, __pyx_t_172, __pyx_bstride_0_grid_dt, __pyx_t_173, __pyx_bstride_1_grid_dt, __pyx_t_174, __pyx_bstride_2_grid_dt) = ((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_168, __pyx_bstride_0_tmax)) - __pyx_v_enter_t);
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":208
 *                 grid_t[cur_ind[0], cur_ind[1], cur_ind[2]] = enter_t
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t
 *                 enter_t = tmax[2]             # <<<<<<<<<<<<<<
 *                 tmax[2] += tdelta[2]
 ...
 */
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":209
 *                 grid_dt[cur_ind[0], cur_ind[1], cur_ind[2]] = tmax[2] - enter_t
 *                 enter_t = tmax[2]
 *                 tmax[2] += tdelta[2]             # <<<<<<<<<<<<<<
 *                 cur_ind[2] += step[2]
 ...
 */
        ...
        *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tmax.buf, __pyx_t_177, __pyx_bstride_0_tmax) += (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_bstruct_tdelta.buf, __pyx_t_176, __pyx_bstride_0_tdelta));
        ...
        /* "yt/yt/lagos/RTIntegrator.pyx":210
 *                 enter_t = tmax[2]
 *                 tmax[2] += tdelta[2]
 *                 cur_ind[2] += step[2]             # <<<<<<<<<<<<<<
 *     return
 */
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":211
 *                 tmax[2] += tdelta[2]
 *                 cur_ind[2] += step[2]
 *     return             # <<<<<<<<<<<<<<
 */
...
/* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":65
...
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":71
 *             # of flags
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":72
 *             cdef int copy_shape, i, ndim
 *             cdef int endian_detector = 1
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":74
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *             ndim = PyArray_NDIM(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":76
 *             ndim = PyArray_NDIM(self)
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 copy_shape = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":77
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 copy_shape = 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":79
 *                 copy_shape = 1
 *             else:
 *                 copy_shape = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":81
 *                 copy_shape = 0
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  if (((__pyx_v_flags & PyBUF_C_CONTIGUOUS) == PyBUF_C_CONTIGUOUS)) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":82
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError("ndarray is not C contiguous")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":83
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):
 *                 raise ValueError("ndarray is not C contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":85
 *                 raise ValueError("ndarray is not C contiguous")
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  if (((__pyx_v_flags & PyBUF_F_CONTIGUOUS) == PyBUF_F_CONTIGUOUS)) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":86
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError("ndarray is not Fortran contiguous")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":87
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):
 *                 raise ValueError("ndarray is not Fortran contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":89
 *                 raise ValueError("ndarray is not Fortran contiguous")
 * 
 *             info.buf = PyArray_DATA(self)             # <<<<<<<<<<<<<<
 *             info.ndim = ndim
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":90
 * 
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim             # <<<<<<<<<<<<<<
 *             if copy_shape:
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":91
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim
 *             if copy_shape:             # <<<<<<<<<<<<<<
 *                 # Allocate new buffer for strides and shape info. This is allocated
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":94
 *                 # Allocate new buffer for strides and shape info. This is allocated
 *                 # as one block, strides first.
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":95
 *                 # as one block, strides first.
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim             # <<<<<<<<<<<<<<
 *                 for i in range(ndim):
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":96
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):             # <<<<<<<<<<<<<<
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 ...
 */
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_v_ndim; __pyx_t_4+=1) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":97
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]             # <<<<<<<<<<<<<<
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":98
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 *                     info.shape[i] = PyArray_DIMS(self)[i]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":100
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":101
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)             # <<<<<<<<<<<<<<
 *             info.suboffsets = NULL
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":102
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL             # <<<<<<<<<<<<<<
 *             info.itemsize = PyArray_ITEMSIZE(self)
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":103
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)             # <<<<<<<<<<<<<<
 *             info.readonly = not PyArray_ISWRITEABLE(self)
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":104
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)
 *             info.readonly = not PyArray_ISWRITEABLE(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":107
 * 
 *             cdef int t
 *             cdef char* f = NULL             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":108
 *             cdef int t
 *             cdef char* f = NULL
 *             cdef dtype descr = self.descr             # <<<<<<<<<<<<<<
 *             cdef list stack
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":112
 *             cdef int offset
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":114
 *             cdef bint hasfields = PyDataType_HASFIELDS(descr)
 * 
 *             if not hasfields and not copy_shape:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":116
 *             if not hasfields and not copy_shape:
 *                 # do not call releasebuffer
 *                 info.obj = None             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":119
 *             else:
 *                 # need to call releasebuffer
 *                 info.obj = self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":121
 *                 info.obj = self
 * 
 *             if not hasfields:             # <<<<<<<<<<<<<<
 *                 t = descr.type_num
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":122
 * 
 *             if not hasfields:
 *                 t = descr.type_num             # <<<<<<<<<<<<<<
 *                 if ((descr.byteorder == '>' and little_endian) or
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":123
 *             if not hasfields:
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 *                     (descr.byteorder == '<' and not little_endian)):
 ...
 */
    ...
    if (!__pyx_t_1) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":124
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *                     raise ValueError("Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":125
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError("Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *                 if   t == NPY_BYTE:        f = "b"
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":126
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError("Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UBYTE:       f = "B"
 ...
 */
    switch (__pyx_v_t) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":127
 *                     raise ValueError("Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_SHORT:       f = "h"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":128
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_USHORT:      f = "H"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":129
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_INT:         f = "i"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":130
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UINT:        f = "I"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":131
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONG:        f = "l"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":132
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONG:       f = "L"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":133
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGLONG:    f = "q"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":134
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":135
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_FLOAT:       f = "f"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":136
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_DOUBLE:      f = "d"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":137
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":138
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":139
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":140
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":141
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_OBJECT:      f = "O"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":142
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 *                 elif t == NPY_OBJECT:      f = "O"             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":144
 *                 elif t == NPY_OBJECT:      f = "O"
 *                 else:
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *                 info.format = f
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":145
 *                 else:
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f             # <<<<<<<<<<<<<<
 *                 return
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":146
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f
 *                 return             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":148
 *                 return
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":149
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment             # <<<<<<<<<<<<<<
 *                 offset = 0
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":150
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment
 *                 offset = 0             # <<<<<<<<<<<<<<
 *                 f = _util_dtypestring(descr, info.format + 1,
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":153
 *                 f = _util_dtypestring(descr, info.format + 1,
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":154
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)
 *                 f[0] = 0 # Terminate format string             # <<<<<<<<<<<<<<
 * 
...
/* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":156
 *                 f[0] = 0 # Terminate format string
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_5numpy_7ndarray___releasebuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info) {
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":157
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.format)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":158
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)             # <<<<<<<<<<<<<<
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":159
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.strides)
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":160
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 stdlib.free(info.strides)             # <<<<<<<<<<<<<<
 *                 # info.shape was stored after info.strides in the same block
...
/* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":277
...
static INLINE char *__pyx_f_5numpy__util_dtypestring(PyArray_Descr *__pyx_v_descr, char *__pyx_v_f, char *__pyx_v_end, int *__pyx_v_offset) {
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":284
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":285
 *     cdef tuple i
 *     cdef int endian_detector = 1
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":287
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *     for i in descr.fields.itervalues():             # <<<<<<<<<<<<<<
 *         child = i[0]
 ...
 */
  ...
  for (;;) {
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":288
 * 
 *     for i in descr.fields.itervalues():
 *         child = i[0]             # <<<<<<<<<<<<<<
 *         new_offset = i[1]
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":289
 *     for i in descr.fields.itervalues():
 *         child = i[0]
 *         new_offset = i[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":291
 *         new_offset = i[1]
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":292
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:
 *             raise RuntimeError("Format string allocated too short, see comment in numpy.pxd")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":294
 *             raise RuntimeError("Format string allocated too short, see comment in numpy.pxd")
 * 
 *         if ((child.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (!__pyx_t_6) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":295
 * 
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *             raise ValueError("Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":296
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):
 *             raise ValueError("Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *             # One could encode it in the format string and have Cython
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":306
 * 
 ...
 */
    while (1) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":307
 *         # Output padding bytes
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":308
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte
 *             f += 1             # <<<<<<<<<<<<<<
 *             offset[0] += 1
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":309
 *             f[0] = 120 # "x"; pad byte
 *             f += 1
 *             offset[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":311
 *             offset[0] += 1
 * 
 *         offset[0] += child.itemsize             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":313
 *         offset[0] += child.itemsize
 * 
 *         if not PyDataType_HASFIELDS(child):             # <<<<<<<<<<<<<<
 *             t = child.type_num
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":314
 * 
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num             # <<<<<<<<<<<<<<
 *             if end - f < 5:
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":315
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num
 *             if end - f < 5:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError("Format string allocated too short.")
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":316
 *             t = child.type_num
 *             if end - f < 5:
 *                 raise RuntimeError("Format string allocated too short.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":319
 * 
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":320
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"             # <<<<<<<<<<<<<<
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":321
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"             # <<<<<<<<<<<<<<
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":322
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"             # <<<<<<<<<<<<<<
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":323
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"             # <<<<<<<<<<<<<<
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":324
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":325
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":326
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":327
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":328
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":329
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"             # <<<<<<<<<<<<<<
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":330
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":331
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"             # <<<<<<<<<<<<<<
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":332
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf             # <<<<<<<<<<<<<<
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":333
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd             # <<<<<<<<<<<<<<
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":334
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg             # <<<<<<<<<<<<<<
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":335
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":337
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 *             else:
 *                 raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":338
 *             else:
 *                 raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *             f += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":342
 *             # Cython ignores struct boundary information ("T{...}"),
 *             # so don't output it
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":343
 *             # so don't output it
 *             f = _util_dtypestring(child, f, end, offset)
 *     return f             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  /* "yt/yt/lagos/RTIntegrator.pyx":26
 * """
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/u/ki/mturk/Research/local/yt-x86_64/lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/stdlib.pxd":2
 * 
