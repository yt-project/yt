...
def create_magnitude_field(registry, basename, field_units,
    ...
    registry.add_field((ftype, f"{basename}_magnitude"),
...
def create_relative_field(registry, basename, field_units, ftype='gas',
    ...
    for d in axis_order:
        registry.add_field((ftype, f"relative_{basename}_{d}"),
                           sampling_type='local',
...
def create_los_field(registry, basename, field_units, 
    ...
    registry.add_field((ftype, f"{basename}_los"),
                       sampling_type='local',
                       function=_los_field,
                       units=field_units,
                       validators=validators)
...
def create_squared_field(registry, basename, field_units,
    ...
    registry.add_field((ftype, f"{basename}_squared"),
                       sampling_type="local",
                       function=_squared,
                       units=field_units,
                       validators=validators)
...
def create_vector_fields(registry, basename, field_units,
    ...
    registry.add_field((ftype, f"{basename}_spherical_radius"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"radial_{basename}"),
                       sampling_type="local",
                       function=_radial,
                       units=field_units,
                       validators=[ValidateParameter("normal"),
    ...
    registry.add_field((ftype, f"radial_{basename}_absolute"),
                       sampling_type="local",
                       function=_radial_absolute,
                       units=field_units)

    registry.add_field((ftype, f"tangential_{basename}"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_spherical_theta"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_spherical_phi"),
                       sampling_type="local",
    ...
    for ax in 'xyz':
        registry.add_field((ftype, f"cutting_plane_{basename}_{ax}"),
                           sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_divergence"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_divergence_absolute"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"tangential_over_{basename}_magnitude"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_cylindrical_radius"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"cylindrical_radial_{basename}"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"cylindrical_radial_{basename}_absolute"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"{basename}_cylindrical_theta"),
                       sampling_type="local",
    ...
    registry.add_field((ftype, f"cylindrical_tangential_{basename}"),
                       sampling_type="local",
                       function=_cylindrical_tangential,
                       units=field_units)

    registry.add_field((ftype, f"cylindrical_tangential_{basename}_absolute"),
                       sampling_type="local",
...
def create_averaged_field(registry, basename, field_units, ftype="gas",
    ...
    registry.add_field((ftype, f"averaged_{basename}"),
                       sampling_type="cell",
