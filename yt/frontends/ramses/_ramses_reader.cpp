 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":608
 *         cdef int varindex = self.field_ind[field]
 *         cdef RAMSES_tree *local_tree = NULL
 *         cdef RAMSES_hydro_data *local_hydro_data = NULL             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":618
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":621
 *         # Note that indexing into a cell is:
 *         #   (k*2 + j)*2 + i
 *         for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_3 = 0; __pyx_t_3 < 3; __pyx_t_3+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":622
 *         #   (k*2 + j)*2 + i
 *         for i in range(3):
 *             end_index[i] = start_index[i] + grid_dims[i]             # <<<<<<<<<<<<<<
 *         for gi in range(len(component_grid_info)):
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":623
 *         for i in range(3):
 *             end_index[i] = start_index[i] + grid_dims[i]
 *         for gi in range(len(component_grid_info)):             # <<<<<<<<<<<<<<
 *             ogrid_info = component_grid_info[gi]
 ...
 */
      ...
      for (__pyx_t_19 = 0; __pyx_t_19 < __pyx_t_24; __pyx_t_19+=1) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":636
 *                 ir = <int> (i / ref_factor)
 *                 for j in range(2 * ref_factor):
 *                     dj = j + og_start_index[1] * ref_factor             # <<<<<<<<<<<<<<
 *                     if dj < start_index[1] or dj >= end_index[1]: continue
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":649
 *                         #print offj, filled.shape[1],
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":651
 *                         if filled[offi, offj, offk] == 1: continue
 * 
 *                         odind = (kr*2 + jr)*2 + ir             # <<<<<<<<<<<<<<
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":653
 *                         odind = (kr*2 + jr)*2 + ir
 *                         temp_data = local_hydro_data.m_var_array[
 *                                 level][8*offset + odind]             # <<<<<<<<<<<<<<
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":654
 *                         temp_data = local_hydro_data.m_var_array[
 *                                 level][8*offset + odind]
 *                         data[offi, offj, offk] = temp_data             # <<<<<<<<<<<<<<
 *                         filled[offi, offj, offk] = 1
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":686
 *         self.sigs = []
 *         for i in range(3):
 *             temp_l[i] = left_index[i] + dimensions[i]             # <<<<<<<<<<<<<<
 *             temp_r[i] = left_index[i]
 ...
 */
    ...
    if (!__pyx_t_12) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":691
 *         for gi in range(ng):
 *             if left_edges[gi,0] > left_index[0]+dimensions[0] or \
 *                right_edges[gi,0] < left_index[0] or \             # <<<<<<<<<<<<<<
 *                left_edges[gi,1] > left_index[1]+dimensions[1] or \
 ...
 */
        ...
        if (!__pyx_t_21) {
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":693
 *                right_edges[gi,0] < left_index[0] or \
 *                left_edges[gi,1] > left_index[1]+dimensions[1] or \
 *                right_edges[gi,1] < left_index[1] or \             # <<<<<<<<<<<<<<
 *                left_edges[gi,2] > left_index[2]+dimensions[2] or \
 ...
 */
            ...
            if (!__pyx_t_30) {
              ...
              /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":695
 *                right_edges[gi,1] < left_index[1] or \
 *                left_edges[gi,2] > left_index[2]+dimensions[2] or \
 *                right_edges[gi,2] < left_index[2]:             # <<<<<<<<<<<<<<
 *                #print "Skipping grid", gi, "which lies outside out box"
 ...
 */
    ...
    if (__pyx_t_16) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":697
 *                right_edges[gi,2] < left_index[2]:
 *                #print "Skipping grid", gi, "which lies outside out box"
 *                continue             # <<<<<<<<<<<<<<
 *             for i in range(3):
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":698
 *                #print "Skipping grid", gi, "which lies outside out box"
 *                continue
 *             for i in range(3):             # <<<<<<<<<<<<<<
 *                 temp_l[i] = i64min(left_edges[gi,i], temp_l[i])
 ...
 */
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":700
 *             for i in range(3):
 *                 temp_l[i] = i64min(left_edges[gi,i], temp_l[i])
 *                 temp_r[i] = i64max(right_edges[gi,i], temp_r[i])             # <<<<<<<<<<<<<<
 *         for i in range(3):
 ...
 */
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":707
 *             if self.dimensions[i] <= 0:
 *                 self.efficiency = -1.0
 *                 return             # <<<<<<<<<<<<<<
 *             self.sigs.append(np.zeros(self.dimensions[i], 'int64'))
 ...
 */
        ...
        /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":731
 *                     i1 = left_edges[gi, 1] + l1
 *                     if i1 < self.left_edge[1]: continue
 *                     if i1 >= self.right_edge[1]: break             # <<<<<<<<<<<<<<
 *                     for l2 in range(grid_dimensions[gi, 2]):
 ...
 */
        ...
        for (__pyx_t_62 = 0; __pyx_t_62 < __pyx_t_63; __pyx_t_62+=1) {
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":733
 *                     if i1 >= self.right_edge[1]: break
 *                     for l2 in range(grid_dimensions[gi, 2]):
 *                         i2 = left_edges[gi, 2] + l2             # <<<<<<<<<<<<<<
 *                         if i2 < self.left_edge[2]: continue
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":736
 *                         if i2 < self.left_edge[2]: continue
 *                         if i2 >= self.right_edge[2]: break
 *                         i = i0 - self.left_edge[0]             # <<<<<<<<<<<<<<
 *                         sig0[i] += 1
 ...
 */
          ...
          *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_sig2.buf, __pyx_t_68, __pyx_bstride_0_sig2) += 1;
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":742
 *                         i = i2 - self.left_edge[2]
 *                         sig2[i] += 1
 *                         efficiency += 1             # <<<<<<<<<<<<<<
 *                         used = 1
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":743
 *                         sig2[i] += 1
 *                         efficiency += 1
 *                         used = 1             # <<<<<<<<<<<<<<
 *             if used == 1:
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":744
 *                         efficiency += 1
 *                         used = 1
 *             if used == 1:             # <<<<<<<<<<<<<<
 *                 grid_file_locations[gi,3] = left_edges[gi, 0]
 ...
 */
    ...
    if (__pyx_t_16) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":745
 *                         used = 1
 *             if used == 1:
 *                 grid_file_locations[gi,3] = left_edges[gi, 0]             # <<<<<<<<<<<<<<
 *                 grid_file_locations[gi,4] = left_edges[gi, 1]
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_grid_file_locations.buf, __pyx_t_56, __pyx_bstride_0_grid_file_locations, __pyx_t_71, __pyx_bstride_1_grid_file_locations) = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_left_edges.buf, __pyx_t_50, __pyx_bstride_0_left_edges, __pyx_t_70, __pyx_bstride_1_left_edges));
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":746
 *             if used == 1:
 *                 grid_file_locations[gi,3] = left_edges[gi, 0]
 *                 grid_file_locations[gi,4] = left_edges[gi, 1]             # <<<<<<<<<<<<<<
 *                 grid_file_locations[gi,5] = left_edges[gi, 2]
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_grid_file_locations.buf, __pyx_t_69, __pyx_bstride_0_grid_file_locations, __pyx_t_73, __pyx_bstride_1_grid_file_locations) = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_left_edges.buf, __pyx_t_62, __pyx_bstride_0_left_edges, __pyx_t_72, __pyx_bstride_1_left_edges));
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":747
 *                 grid_file_locations[gi,3] = left_edges[gi, 0]
 *                 grid_file_locations[gi,4] = left_edges[gi, 1]
 *                 grid_file_locations[gi,5] = left_edges[gi, 2]             # <<<<<<<<<<<<<<
 *                 self.grid_file_locations.append(grid_file_locations[gi,:])
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_grid_file_locations.buf, __pyx_t_76, __pyx_bstride_0_grid_file_locations, __pyx_t_77, __pyx_bstride_1_grid_file_locations) = (*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_left_edges.buf, __pyx_t_74, __pyx_bstride_0_left_edges, __pyx_t_75, __pyx_bstride_1_left_edges));
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":748
 *                 grid_file_locations[gi,4] = left_edges[gi, 1]
 *                 grid_file_locations[gi,5] = left_edges[gi, 2]
 *                 self.grid_file_locations.append(grid_file_locations[gi,:])             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":750
 *                 self.grid_file_locations.append(grid_file_locations[gi,:])
 * 
 *         self.dd = np.ones(3, dtype='int64')             # <<<<<<<<<<<<<<
 *         for i in range(3):
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":751
 * 
 *         self.dd = np.ones(3, dtype='int64')
 *         for i in range(3):             # <<<<<<<<<<<<<<
 *             efficiency /= self.dimensions[i]
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":752
 *         self.dd = np.ones(3, dtype='int64')
 *         for i in range(3):
 *             efficiency /= self.dimensions[i]             # <<<<<<<<<<<<<<
 *             self.dd[i] = self.dimensions[i]
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":753
 *         for i in range(3):
 *             efficiency /= self.dimensions[i]
 *             self.dd[i] = self.dimensions[i]             # <<<<<<<<<<<<<<
 *         #print "Efficiency is %0.3e" % (efficiency)
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":755
 *             self.dd[i] = self.dimensions[i]
 *         #print "Efficiency is %0.3e" % (efficiency)
 *         self.efficiency = efficiency             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":757
 *         self.efficiency = efficiency
 * 
 *     def find_split(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_2yt_13ramses_reader_12ProtoSubgrid_find_split(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":762
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":764
 *         axes = np.argsort(self.dd)[::-1]
 *         cdef np.ndarray[np.int64_t] sig
 *         for axi in range(3):             # <<<<<<<<<<<<<<
 *             ax = axes[axi]
 ...
 */
  for (__pyx_t_9 = 0; __pyx_t_9 < 3; __pyx_t_9+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":765
 *         cdef np.ndarray[np.int64_t] sig
 *         for axi in range(3):
 *             ax = axes[axi]             # <<<<<<<<<<<<<<
 *             center = self.dimensions[ax] / 2
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":766
 *         for axi in range(3):
 *             ax = axes[axi]
 *             center = self.dimensions[ax] / 2             # <<<<<<<<<<<<<<
 *             sig = self.sigs[ax]
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":767
 *             ax = axes[axi]
 *             center = self.dimensions[ax] / 2
 *             sig = self.sigs[ax]             # <<<<<<<<<<<<<<
 *             for i in range(self.dimensions[ax]):
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":768
 *             center = self.dimensions[ax] / 2
 *             sig = self.sigs[ax]
 *             for i in range(self.dimensions[ax]):             # <<<<<<<<<<<<<<
 *                 if sig[i] == 0 and i > 0 and i < self.dimensions[ax] - 1:
 ...
 */
    ...
    for (__pyx_t_5 = 0; __pyx_t_5 < __pyx_t_12; __pyx_t_5+=1) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":769
 *             sig = self.sigs[ax]
 *             for i in range(self.dimensions[ax]):
 *                 if sig[i] == 0 and i > 0 and i < self.dimensions[ax] - 1:             # <<<<<<<<<<<<<<
 *                     #print "zero: %s (%s)" % (i, self.dimensions[ax])
 ...
 */
      ...
      if (__pyx_t_16) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":771
 *                 if sig[i] == 0 and i > 0 and i < self.dimensions[ax] - 1:
 *                     #print "zero: %s (%s)" % (i, self.dimensions[ax])
 *                     return 'zs', ax, i             # <<<<<<<<<<<<<<
 *         zcstrength = 0
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":772
 *                     #print "zero: %s (%s)" % (i, self.dimensions[ax])
 *                     return 'zs', ax, i
 *         zcstrength = 0             # <<<<<<<<<<<<<<
 *         zcp = 0
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":773
 *                     return 'zs', ax, i
 *         zcstrength = 0
 *         zcp = 0             # <<<<<<<<<<<<<<
 *         zca = -1
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":774
 *         zcstrength = 0
 *         zcp = 0
 *         zca = -1             # <<<<<<<<<<<<<<
 *         cdef int temp
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":777
 *         cdef int temp
 *         cdef np.int64_t *sig2d
 *         for axi in range(3):             # <<<<<<<<<<<<<<
 *             ax = axes[axi]
 ...
 */
  for (__pyx_t_9 = 0; __pyx_t_9 < 3; __pyx_t_9+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":778
 *         cdef np.int64_t *sig2d
 *         for axi in range(3):
 *             ax = axes[axi]             # <<<<<<<<<<<<<<
 *             sig = self.sigs[ax]
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":779
 *         for axi in range(3):
 *             ax = axes[axi]
 *             sig = self.sigs[ax]             # <<<<<<<<<<<<<<
 *             sig2d = <np.int64_t *> malloc(sizeof(np.int64_t) * self.dimensions[ax])
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":780
 *             ax = axes[axi]
 *             sig = self.sigs[ax]
 *             sig2d = <np.int64_t *> malloc(sizeof(np.int64_t) * self.dimensions[ax])             # <<<<<<<<<<<<<<
 *             sig2d[0] = sig2d[self.dimensions[ax]-1] = 0
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":781
 *             sig = self.sigs[ax]
 *             sig2d = <np.int64_t *> malloc(sizeof(np.int64_t) * self.dimensions[ax])
 *             sig2d[0] = sig2d[self.dimensions[ax]-1] = 0             # <<<<<<<<<<<<<<
 *             for i in range(1, self.dimensions[ax] - 1):
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":782
 *             sig2d = <np.int64_t *> malloc(sizeof(np.int64_t) * self.dimensions[ax])
 *             sig2d[0] = sig2d[self.dimensions[ax]-1] = 0
 *             for i in range(1, self.dimensions[ax] - 1):             # <<<<<<<<<<<<<<
 *                 sig2d[i] = sig[i-1] - 2*sig[i] + sig[i+1]
 ...
 */
    ...
    for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_12; __pyx_t_5+=1) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":783
 *             sig2d[0] = sig2d[self.dimensions[ax]-1] = 0
 *             for i in range(1, self.dimensions[ax] - 1):
 *                 sig2d[i] = sig[i-1] - 2*sig[i] + sig[i+1]             # <<<<<<<<<<<<<<
 *             for i in range(1, self.dimensions[ax] - 1):
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":784
 *             for i in range(1, self.dimensions[ax] - 1):
 *                 sig2d[i] = sig[i-1] - 2*sig[i] + sig[i+1]
 *             for i in range(1, self.dimensions[ax] - 1):             # <<<<<<<<<<<<<<
 *                 if sig2d[i] * sig2d[i+1] <= 0:
 ...
 */
    ...
    for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_12; __pyx_t_5+=1) {
      ...
      /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":785
 *                 sig2d[i] = sig[i-1] - 2*sig[i] + sig[i+1]
 *             for i in range(1, self.dimensions[ax] - 1):
 *                 if sig2d[i] * sig2d[i+1] <= 0:             # <<<<<<<<<<<<<<
 *                     strength = labs(sig2d[i] - sig2d[i+1])
 ...
 */
      ...
      if (__pyx_t_16) {
        ...
        /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":786
 *             for i in range(1, self.dimensions[ax] - 1):
 *                 if sig2d[i] * sig2d[i+1] <= 0:
 *                     strength = labs(sig2d[i] - sig2d[i+1])             # <<<<<<<<<<<<<<
 *                     if (strength > zcstrength) or \
 ...
 */
        ...
        /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":787
 *                 if sig2d[i] * sig2d[i+1] <= 0:
 *                     strength = labs(sig2d[i] - sig2d[i+1])
 *                     if (strength > zcstrength) or \             # <<<<<<<<<<<<<<
 *                        (strength == zcstrength and (abs(center - i) <
 ...
 */
        ...
        if (!__pyx_t_16) {
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":788
 *                     strength = labs(sig2d[i] - sig2d[i+1])
 *                     if (strength > zcstrength) or \
 *                        (strength == zcstrength and (abs(center - i) <             # <<<<<<<<<<<<<<
 *                                                     abs(center - zcp))):
 ...
 */
          ...
          if (__pyx_t_15) {
            ...
            /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":789
 *                     if (strength > zcstrength) or \
 *                        (strength == zcstrength and (abs(center - i) <
 *                                                     abs(center - zcp))):             # <<<<<<<<<<<<<<
 *                         zcstrength = strength
 ...
 */
        ...
        if (__pyx_t_15) {
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":790
 *                        (strength == zcstrength and (abs(center - i) <
 *                                                     abs(center - zcp))):
 *                         zcstrength = strength             # <<<<<<<<<<<<<<
 *                         zcp = i
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":791
 *                                                     abs(center - zcp))):
 *                         zcstrength = strength
 *                         zcp = i             # <<<<<<<<<<<<<<
 *                         zca = ax
 ...
 */
          ...
          /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":792
 *                         zcstrength = strength
 *                         zcp = i
 *                         zca = ax             # <<<<<<<<<<<<<<
 *             free(sig2d)
 ...
 */
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":793
 *                         zcp = i
 *                         zca = ax
 *             free(sig2d)             # <<<<<<<<<<<<<<
 *         #print "zcp: %s (%s)" % (zcp, self.dimensions[ax])
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":795
 *             free(sig2d)
 *         #print "zcp: %s (%s)" % (zcp, self.dimensions[ax])
 *         return 'zc', ax, zcp             # <<<<<<<<<<<<<<
 * 
...
/* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":797
 *         return 'zc', ax, zcp
 * 
 *     def get_properties(self):             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pf_2yt_13ramses_reader_12ProtoSubgrid_get_properties(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":798
 * 
 *     def get_properties(self):
 *         cdef np.ndarray[np.int64_t, ndim=2] tr = np.empty((3,3), dtype='int64')             # <<<<<<<<<<<<<<
 *         cdef int i
 ...
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":800
 *         cdef np.ndarray[np.int64_t, ndim=2] tr = np.empty((3,3), dtype='int64')
 *         cdef int i
 *         for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_6 = 0; __pyx_t_6 < 3; __pyx_t_6+=1) {
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":801
 *         cdef int i
 *         for i in range(3):
 *             tr[0,i] = self.left_edge[i]             # <<<<<<<<<<<<<<
 *             tr[1,i] = self.right_edge[i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_tr.buf, __pyx_t_7, __pyx_bstride_0_tr, __pyx_t_8, __pyx_bstride_1_tr) = (((struct __pyx_obj_2yt_13ramses_reader_ProtoSubgrid *)__pyx_v_self)->left_edge[__pyx_v_i]);
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":802
 *         for i in range(3):
 *             tr[0,i] = self.left_edge[i]
 *             tr[1,i] = self.right_edge[i]             # <<<<<<<<<<<<<<
 *             tr[2,i] = self.dimensions[i]
 ...
 */
    ...
    *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_int64_t *, __pyx_bstruct_tr.buf, __pyx_t_10, __pyx_bstride_0_tr, __pyx_t_9, __pyx_bstride_1_tr) = (((struct __pyx_obj_2yt_13ramses_reader_ProtoSubgrid *)__pyx_v_self)->right_edge[__pyx_v_i]);
    ...
    /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":803
 *             tr[0,i] = self.left_edge[i]
 *             tr[1,i] = self.right_edge[i]
 *             tr[2,i] = self.dimensions[i]             # <<<<<<<<<<<<<<
 *         return tr
 */
  ...
  /* "/Users/matthewturk/yt/yt/yt/ramses_reader.pyx":804
 *             tr[1,i] = self.right_edge[i]
 *             tr[2,i] = self.dimensions[i]
 *         return tr             # <<<<<<<<<<<<<<
 */
