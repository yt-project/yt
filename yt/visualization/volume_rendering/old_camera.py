...
from yt.funcs import (ensure_numpy_array, get_num_threads, get_pbar, iterable,
                      mylog)
...
from yt.utilities.lib.grid_traversal import (arr_fisheye_vectors,
                                             arr_pix2vec_nest,
                                             pixelize_healpix)
from yt.utilities.lib.image_samplers import (InterpolatedProjectionSampler,
...
from yt.visualization.image_writer import (apply_colormap, write_bitmap,
                                           write_image)
...
class Camera(ParallelAnalysisInterface):
    ...
    def __init__(
        ...
        if self.no_ghost:
            mylog.info(
                "Warning: no_ghost is currently True (default). This may lead to artifacts at grid boundaries."
            )
