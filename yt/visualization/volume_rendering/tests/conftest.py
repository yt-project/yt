...
from yt.testing import fake_hexahedral_ds, fake_vr_orientation_test_ds
...
def pytest_generate_tests(metafunc):
    ...
    if metafunc.function.__name__ == "test_vr_images":
        ...
        metafunc.parametrize(
            "lens_type", lens_types, ids=["plane-parallel", "perspective"]
        )
