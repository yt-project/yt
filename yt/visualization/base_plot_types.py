...
from yt.funcs import (get_brewer_cmap, get_image_suffix, get_interactivity,
                      iterable, matplotlib_style_context, mylog)
...
class PlotMPL:
    ...
    def save(self, name, mpl_kwargs=None, canvas=None):
        ...
        from ._mpl_imports import (FigureCanvasAgg, FigureCanvasPdf,
                                   FigureCanvasPS, FigureCanvasSVG)
