/* Generated by Cython 0.11.2 on Tue Sep 22 12:27:28 2009 */
...
/* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":44
...
/* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":56
...
static int __pyx_pf_2yt_10extensions_16volume_rendering_16VolumeIntegrator_15PartitionedGrid___cinit__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":63
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":64
 *         cdef int i
 *         self.LeftEdge = left_edge
 *         self.RightEdge = right_edge             # <<<<<<<<<<<<<<
 *         cdef np.ndarray[np.float64_t, ndim=3] tdata = data.copy()
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":65
 *         self.LeftEdge = left_edge
 *         self.RightEdge = right_edge
 *         cdef np.ndarray[np.float64_t, ndim=3] tdata = data.copy()             # <<<<<<<<<<<<<<
 *         self.my_data = tdata
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":66
 *         self.RightEdge = right_edge
 *         cdef np.ndarray[np.float64_t, ndim=3] tdata = data.copy()
 *         self.my_data = tdata             # <<<<<<<<<<<<<<
 *         self.data = <np.float64_t *> (tdata.data)
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":67
 *         cdef np.ndarray[np.float64_t, ndim=3] tdata = data.copy()
 *         self.my_data = tdata
 *         self.data = <np.float64_t *> (tdata.data)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":69
 *         self.data = <np.float64_t *> (tdata.data)
 * 
 *         for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_4 = 0; __pyx_t_4 < 3; __pyx_t_4+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":70
 * 
 *         for i in range(3):
 *             self.left_edge[i] = left_edge[i]             # <<<<<<<<<<<<<<
 *             self.right_edge[i] = right_edge[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":71
 *         for i in range(3):
 *             self.left_edge[i] = left_edge[i]
 *             self.right_edge[i] = right_edge[i]             # <<<<<<<<<<<<<<
 *             self.dims[i] = dims[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":72
 *             self.left_edge[i] = left_edge[i]
 *             self.right_edge[i] = right_edge[i]
 *             self.dims[i] = dims[i]             # <<<<<<<<<<<<<<
 *             self.dds[i] = (self.right_edge[i] - self.left_edge[i])/dims[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":73
 *             self.right_edge[i] = right_edge[i]
 *             self.dims[i] = dims[i]
 *             self.dds[i] = (self.right_edge[i] - self.left_edge[i])/dims[i]             # <<<<<<<<<<<<<<
 * 
...
/* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":77
 *     @cython.boundscheck(False)
 *     @cython.wraparound(False)
...
static PyObject *__pyx_pf_2yt_10extensions_16volume_rendering_16VolumeIntegrator_15PartitionedGrid_cast_plane(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":86
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":87
 *         cdef int vi, hit, i
 *         cdef int nv = vp_pos.shape[0]
 *         cdef int nshells = shells.shape[0]             # <<<<<<<<<<<<<<
 *         cdef np.float64_t v_pos[3]
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":91
 *         cdef np.float64_t v_dir[3]
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":92
 *         cdef np.float64_t rgba[4]
 *         for i in range(3): v_dir[i] = vp_dir[i]
 *         hit = 0             # <<<<<<<<<<<<<<
 *         for vi in range(nv):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":93
 *         for i in range(3): v_dir[i] = vp_dir[i]
 *         hit = 0
 *         for vi in range(nv):             # <<<<<<<<<<<<<<
 *             # Copy into temporary space
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_v_nv; __pyx_t_1+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":95
 *         for vi in range(nv):
 *             # Copy into temporary space
 *             for i in range(3): v_pos[i] = vp_pos[vi,i]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":96
 *             # Copy into temporary space
 *             for i in range(3): v_pos[i] = vp_pos[vi,i]
 *             for i in range(4): rgba[i] = image_plane[vi,i]             # <<<<<<<<<<<<<<
 *             if dt > 0:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":97
 *             for i in range(3): v_pos[i] = vp_pos[vi,i]
 *             for i in range(4): rgba[i] = image_plane[vi,i]
 *             if dt > 0:             # <<<<<<<<<<<<<<
 *                 hit += self.sample_ray(v_pos, v_dir, nshells, rgba,
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":99
 *             if dt > 0:
 *                 hit += self.sample_ray(v_pos, v_dir, nshells, rgba,
 *                                          <np.float64_t *> shells.data, dt)             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":102
 *             else:
 *                 hit += self.integrate_ray(v_pos, v_dir, nshells, rgba,
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":103
 *                 hit += self.integrate_ray(v_pos, v_dir, nshells, rgba,
 *                                          <np.float64_t *> shells.data)
 *             for i in range(4): image_plane[vi,i] = rgba[i]             # <<<<<<<<<<<<<<
 *         return hit
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":104
 *                                          <np.float64_t *> shells.data)
 *             for i in range(4): image_plane[vi,i] = rgba[i]
 *         return hit             # <<<<<<<<<<<<<<
 * 
...
/* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":108
 *     @cython.boundscheck(False)
 *     @cython.wraparound(False)
...
static  int __pyx_f_2yt_10extensions_16volume_rendering_16VolumeIntegrator_15PartitionedGrid_integrate_ray(struct __pyx_obj_2yt_10extensions_16volume_rendering_16VolumeIntegrator_PartitionedGrid *__pyx_v_self, __pyx_t_5numpy_float64_t *__pyx_v_v_pos, __pyx_t_5numpy_float64_t *__pyx_v_v_dir, int __pyx_v_nshells, __pyx_t_5numpy_float64_t *__pyx_v_rgba, __pyx_t_5numpy_float64_t *__pyx_v_shells) {
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":114
 *                                  np.float64_t *shells):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":118
 *         cdef np.float64_t enter_t, dist, alpha, dt
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":119
 *         cdef np.float64_t tr, tl, temp_x, temp_y, dv
 *         for i in range(3):
 *             if (v_dir[i] < 0):             # <<<<<<<<<<<<<<
 *                 step[i] = -1
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":120
 *         for i in range(3):
 *             if (v_dir[i] < 0):
 *                 step[i] = -1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":122
 *                 step[i] = -1
 *             else:
 *                 step[i] = 1             # <<<<<<<<<<<<<<
 *             x = (i+1) % 3
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":123
 *             else:
 *                 step[i] = 1
 *             x = (i+1) % 3             # <<<<<<<<<<<<<<
 *             y = (i+2) % 3
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":124
 *                 step[i] = 1
 *             x = (i+1) % 3
 *             y = (i+2) % 3             # <<<<<<<<<<<<<<
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":125
 *             x = (i+1) % 3
 *             y = (i+2) % 3
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]             # <<<<<<<<<<<<<<
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":126
 *             y = (i+2) % 3
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]             # <<<<<<<<<<<<<<
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":127
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 *             temp_x = (v_pos[x] + tl*v_dir[x])             # <<<<<<<<<<<<<<
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":128
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 *             temp_y = (v_pos[y] + tl*v_dir[y])             # <<<<<<<<<<<<<<
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":129
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \             # <<<<<<<<<<<<<<
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 ...
 */
    if (((__pyx_v_self->left_edge[__pyx_v_x]) <= __pyx_v_temp_x)) {
      if ((__pyx_v_temp_x <= (__pyx_v_self->right_edge[__pyx_v_x]))) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":130
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \             # <<<<<<<<<<<<<<
 *                0.0 <= tl and tl < intersect_t:
 ...
 */
        if (((__pyx_v_self->left_edge[__pyx_v_y]) <= __pyx_v_temp_y)) {
          if ((__pyx_v_temp_y <= (__pyx_v_self->right_edge[__pyx_v_y]))) {
            ...
            /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":131
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 *                0.0 <= tl and tl < intersect_t:             # <<<<<<<<<<<<<<
 *                 intersect_t = tl
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":132
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 *                0.0 <= tl and tl < intersect_t:
 *                 intersect_t = tl             # <<<<<<<<<<<<<<
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":133
 *                0.0 <= tl and tl < intersect_t:
 *                 intersect_t = tl
 *             temp_x = (v_pos[x] + tr*v_dir[x])             # <<<<<<<<<<<<<<
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":134
 *                 intersect_t = tl
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 *             temp_y = (v_pos[y] + tr*v_dir[y])             # <<<<<<<<<<<<<<
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":135
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \             # <<<<<<<<<<<<<<
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 ...
 */
    if (((__pyx_v_self->left_edge[__pyx_v_x]) <= __pyx_v_temp_x)) {
      if ((__pyx_v_temp_x <= (__pyx_v_self->right_edge[__pyx_v_x]))) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":136
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \             # <<<<<<<<<<<<<<
 *                0.0 <= tr and tr < intersect_t:
 ...
 */
        if (((__pyx_v_self->left_edge[__pyx_v_y]) <= __pyx_v_temp_y)) {
          if ((__pyx_v_temp_y <= (__pyx_v_self->right_edge[__pyx_v_y]))) {
            ...
            /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":137
 *             if self.left_edge[x] <= temp_x and temp_x <= self.right_edge[x] and \
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 *                0.0 <= tr and tr < intersect_t:             # <<<<<<<<<<<<<<
 *                 intersect_t = tr
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":138
 *                self.left_edge[y] <= temp_y and temp_y <= self.right_edge[y] and \
 *                0.0 <= tr and tr < intersect_t:
 *                 intersect_t = tr             # <<<<<<<<<<<<<<
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":139
 *                0.0 <= tr and tr < intersect_t:
 *                 intersect_t = tr
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \             # <<<<<<<<<<<<<<
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 ...
 */
  if (((__pyx_v_self->left_edge[0]) <= (__pyx_v_v_pos[0]))) {
    if (((__pyx_v_v_pos[0]) <= (__pyx_v_self->right_edge[0]))) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":140
 *                 intersect_t = tr
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \             # <<<<<<<<<<<<<<
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 ...
 */
      if (((__pyx_v_self->left_edge[1]) <= (__pyx_v_v_pos[1]))) {
        if (((__pyx_v_v_pos[1]) <= (__pyx_v_self->right_edge[1]))) {
          ...
          /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":141
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:             # <<<<<<<<<<<<<<
 *             intersect_t = 0.0
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":142
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 *             intersect_t = 0.0             # <<<<<<<<<<<<<<
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":143
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 *             intersect_t = 0.0
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):             # <<<<<<<<<<<<<<
 *             return 0
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":144
 *             intersect_t = 0.0
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 *             return 0             # <<<<<<<<<<<<<<
 *         for i in range(3):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":145
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 *             return 0
 *         for i in range(3):             # <<<<<<<<<<<<<<
 *             intersect[i] = v_pos[i] + intersect_t * v_dir[i]
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":146
 *             return 0
 *         for i in range(3):
 *             intersect[i] = v_pos[i] + intersect_t * v_dir[i]             # <<<<<<<<<<<<<<
 *             cur_ind[i] = <int> floor((intersect[i] + 1e-8*self.dds[i] -
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":147
 *         for i in range(3):
 *             intersect[i] = v_pos[i] + intersect_t * v_dir[i]
 *             cur_ind[i] = <int> floor((intersect[i] + 1e-8*self.dds[i] -             # <<<<<<<<<<<<<<
 *                                       self.left_edge[i])/self.dds[i])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":149
 *             cur_ind[i] = <int> floor((intersect[i] + 1e-8*self.dds[i] -
 *                                       self.left_edge[i])/self.dds[i])
 *             tmax[i] = (((cur_ind[i]+step[i])*self.dds[i])+             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":151
 *             tmax[i] = (((cur_ind[i]+step[i])*self.dds[i])+
 *                         self.left_edge[i]-v_pos[i])/v_dir[i]
 *             if cur_ind[i] == self.dims[i] and step[i] < 0:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":152
 *                         self.left_edge[i]-v_pos[i])/v_dir[i]
 *             if cur_ind[i] == self.dims[i] and step[i] < 0:
 *                 cur_ind[i] = self.dims[i] - 1             # <<<<<<<<<<<<<<
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":153
 *             if cur_ind[i] == self.dims[i] and step[i] < 0:
 *                 cur_ind[i] = self.dims[i] - 1
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:             # <<<<<<<<<<<<<<
 *                 return 0
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":154
 *                 cur_ind[i] = self.dims[i] - 1
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 *                 return 0             # <<<<<<<<<<<<<<
 *             if step[i] > 0:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":155
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 *                 return 0
 *             if step[i] > 0:             # <<<<<<<<<<<<<<
 *                 tmax[i] = (((cur_ind[i]+1)*self.dds[i])
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":156
 *                 return 0
 *             if step[i] > 0:
 *                 tmax[i] = (((cur_ind[i]+1)*self.dds[i])             # <<<<<<<<<<<<<<
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":158
 *                 tmax[i] = (((cur_ind[i]+1)*self.dds[i])
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 *             if step[i] < 0:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":159
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 *             if step[i] < 0:
 *                 tmax[i] = (((cur_ind[i]+0)*self.dds[i])             # <<<<<<<<<<<<<<
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":161
 *                 tmax[i] = (((cur_ind[i]+0)*self.dds[i])
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 *             tdelta[i] = (self.dds[i]/v_dir[i])             # <<<<<<<<<<<<<<
 *             if tdelta[i] < 0:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":162
 *                             +self.left_edge[i]-v_pos[i])/v_dir[i]
 *             tdelta[i] = (self.dds[i]/v_dir[i])
 *             if tdelta[i] < 0:             # <<<<<<<<<<<<<<
 *                 tdelta[i] *= -1
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":163
 *             tdelta[i] = (self.dds[i]/v_dir[i])
 *             if tdelta[i] < 0:
 *                 tdelta[i] *= -1             # <<<<<<<<<<<<<<
 *         enter_t = intersect_t
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":164
 *             if tdelta[i] < 0:
 *                 tdelta[i] *= -1
 *         enter_t = intersect_t             # <<<<<<<<<<<<<<
 *         while 1:
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":165
 *                 tdelta[i] *= -1
 *         enter_t = intersect_t
 *         while 1:             # <<<<<<<<<<<<<<
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 ...
 */
  while (1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":166
 *         enter_t = intersect_t
 *         while 1:
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \             # <<<<<<<<<<<<<<
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 ...
 */
    ...
    if (!(!__pyx_t_3)) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":167
 *         while 1:
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \             # <<<<<<<<<<<<<<
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 ...
 */
      ...
      if (!(!__pyx_t_2)) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":168
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 *                (not (0 <= cur_ind[2] < self.dims[2])):             # <<<<<<<<<<<<<<
 *                 break
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":169
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 *                 break             # <<<<<<<<<<<<<<
 *             hit += 1
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":170
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 *                 break
 *             hit += 1             # <<<<<<<<<<<<<<
 *             flat_ind = (((cur_ind[2])*self.dims[1]+(cur_ind[1]))*self.dims[0]+cur_ind[0])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":171
 *                 break
 *             hit += 1
 *             flat_ind = (((cur_ind[2])*self.dims[1]+(cur_ind[1]))*self.dims[0]+cur_ind[0])             # <<<<<<<<<<<<<<
 *             dv = self.data[flat_ind]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":172
 *             hit += 1
 *             flat_ind = (((cur_ind[2])*self.dims[1]+(cur_ind[1]))*self.dims[0]+cur_ind[0])
 *             dv = self.data[flat_ind]             # <<<<<<<<<<<<<<
 *             # Do our transfer here
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":174
 *             dv = self.data[flat_ind]
 *             # Do our transfer here
 *             eval_shells(nshells, dv, shells, rgba)             # <<<<<<<<<<<<<<
 ...
 *                 dt = 1.0 - enter_t
 */
    eval_shells(__pyx_v_nshells, __pyx_v_dv, __pyx_v_shells, __pyx_v_rgba);

    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":175
 *             # Do our transfer here
 *             eval_shells(nshells, dv, shells, rgba)
 *             if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):             # <<<<<<<<<<<<<<
 *                 dt = 1.0 - enter_t
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":176
 *             eval_shells(nshells, dv, shells, rgba)
 *             if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):
 *                 dt = 1.0 - enter_t             # <<<<<<<<<<<<<<
 *                 rgba[2] += dt
 ...
 */
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":177
 *             if (tmax[0] > 1.0) and (tmax[1] > 1.0) and (tmax[2] > 1.0):
 *                 dt = 1.0 - enter_t
 *                 rgba[2] += dt             # <<<<<<<<<<<<<<
 *                 break
 ...
 */
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":178
 *                 dt = 1.0 - enter_t
 *                 rgba[2] += dt
 *                 break             # <<<<<<<<<<<<<<
 *             if tmax[0] < tmax[1]:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":179
 *                 rgba[2] += dt
 *                 break
 *             if tmax[0] < tmax[1]:             # <<<<<<<<<<<<<<
 *                 if tmax[0] < tmax[2]:
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":180
 *                 break
 *             if tmax[0] < tmax[1]:
 *                 if tmax[0] < tmax[2]:             # <<<<<<<<<<<<<<
 *                     dt = tmax[0] - enter_t
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":181
 *             if tmax[0] < tmax[1]:
 *                 if tmax[0] < tmax[2]:
 *                     dt = tmax[0] - enter_t             # <<<<<<<<<<<<<<
 *                     enter_t = tmax[0]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":182
 *                 if tmax[0] < tmax[2]:
 *                     dt = tmax[0] - enter_t
 *                     enter_t = tmax[0]             # <<<<<<<<<<<<<<
 *                     tmax[0] += tdelta[0]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":183
 *                     dt = tmax[0] - enter_t
 *                     enter_t = tmax[0]
 *                     tmax[0] += tdelta[0]             # <<<<<<<<<<<<<<
 *                     cur_ind[0] += step[0]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":184
 *                     enter_t = tmax[0]
 *                     tmax[0] += tdelta[0]
 *                     cur_ind[0] += step[0]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":186
 *                     cur_ind[0] += step[0]
 *                 else:
 *                     dt = tmax[2] - enter_t             # <<<<<<<<<<<<<<
 *                     enter_t = tmax[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":187
 *                 else:
 *                     dt = tmax[2] - enter_t
 *                     enter_t = tmax[2]             # <<<<<<<<<<<<<<
 *                     tmax[2] += tdelta[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":188
 *                     dt = tmax[2] - enter_t
 *                     enter_t = tmax[2]
 *                     tmax[2] += tdelta[2]             # <<<<<<<<<<<<<<
 *                     cur_ind[2] += step[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":189
 *                     enter_t = tmax[2]
 *                     tmax[2] += tdelta[2]
 *                     cur_ind[2] += step[2]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":191
 *                     cur_ind[2] += step[2]
 *             else:
 *                 if tmax[1] < tmax[2]:             # <<<<<<<<<<<<<<
 *                     dt = tmax[1] - enter_t
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":192
 *             else:
 *                 if tmax[1] < tmax[2]:
 *                     dt = tmax[1] - enter_t             # <<<<<<<<<<<<<<
 *                     enter_t = tmax[1]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":193
 *                 if tmax[1] < tmax[2]:
 *                     dt = tmax[1] - enter_t
 *                     enter_t = tmax[1]             # <<<<<<<<<<<<<<
 *                     tmax[1] += tdelta[1]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":194
 *                     dt = tmax[1] - enter_t
 *                     enter_t = tmax[1]
 *                     tmax[1] += tdelta[1]             # <<<<<<<<<<<<<<
 *                     cur_ind[1] += step[1]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":195
 *                     enter_t = tmax[1]
 *                     tmax[1] += tdelta[1]
 *                     cur_ind[1] += step[1]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":197
 *                     cur_ind[1] += step[1]
 *                 else:
 *                     dt = tmax[2] - enter_t             # <<<<<<<<<<<<<<
 *                     enter_t = tmax[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":198
 *                 else:
 *                     dt = tmax[2] - enter_t
 *                     enter_t = tmax[2]             # <<<<<<<<<<<<<<
 *                     tmax[2] += tdelta[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":199
 *                     dt = tmax[2] - enter_t
 *                     enter_t = tmax[2]
 *                     tmax[2] += tdelta[2]             # <<<<<<<<<<<<<<
 *                     cur_ind[2] += step[2]
 ...
 */
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":200
 *                     enter_t = tmax[2]
 *                     tmax[2] += tdelta[2]
 *                     cur_ind[2] += step[2]             # <<<<<<<<<<<<<<
 *             rgba[2] += dt
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":201
 *                     tmax[2] += tdelta[2]
 *                     cur_ind[2] += step[2]
 *             rgba[2] += dt             # <<<<<<<<<<<<<<
 *         return hit
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":202
 *                     cur_ind[2] += step[2]
 *             rgba[2] += dt
 *         return hit             # <<<<<<<<<<<<<<
 * 
...
/* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":206
 *     @cython.boundscheck(False)
 *     @cython.wraparound(False)
...
static  int __pyx_f_2yt_10extensions_16volume_rendering_16VolumeIntegrator_15PartitionedGrid_sample_ray(struct __pyx_obj_2yt_10extensions_16volume_rendering_16VolumeIntegrator_PartitionedGrid *__pyx_v_self, __pyx_t_5numpy_float64_t *__pyx_v_v_pos, __pyx_t_5numpy_float64_t *__pyx_v_v_dir, int __pyx_v_nshells, __pyx_t_5numpy_float64_t *__pyx_v_rgba, __pyx_t_5numpy_float64_t *__pyx_v_shells, __pyx_t_5numpy_float64_t __pyx_v_dt) {
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":213
 *                               np.float64_t dt):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":216
 *         cdef np.float64_t dist, alpha, t
 *         cdef np.float64_t tr, tl, temp_x, temp_y, dv
 *         for i in range(3):             # <<<<<<<<<<<<<<
 *             x = (i+1) % 3
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":217
 *         cdef np.float64_t tr, tl, temp_x, temp_y, dv
 *         for i in range(3):
 *             x = (i+1) % 3             # <<<<<<<<<<<<<<
 *             y = (i+2) % 3
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":218
 *         for i in range(3):
 *             x = (i+1) % 3
 *             y = (i+2) % 3             # <<<<<<<<<<<<<<
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":219
 *             x = (i+1) % 3
 *             y = (i+2) % 3
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]             # <<<<<<<<<<<<<<
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":220
 *             y = (i+2) % 3
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]             # <<<<<<<<<<<<<<
 *             if tl < 0.0 and tr < 0.0: return 0
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":221
 *             tl = (self.left_edge[i] - v_pos[i])/v_dir[i]
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 *             if tl < 0.0 and tr < 0.0: return 0             # <<<<<<<<<<<<<<
 *             if tl > 1.0 and tr > 1.0: return 0
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":222
 *             tr = (self.right_edge[i] - v_pos[i])/v_dir[i]
 *             if tl < 0.0 and tr < 0.0: return 0
 *             if tl > 1.0 and tr > 1.0: return 0             # <<<<<<<<<<<<<<
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":223
 *             if tl < 0.0 and tr < 0.0: return 0
 *             if tl > 1.0 and tr > 1.0: return 0
 *             temp_x = (v_pos[x] + tl*v_dir[x])             # <<<<<<<<<<<<<<
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":224
 *             if tl > 1.0 and tr > 1.0: return 0
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 *             temp_y = (v_pos[y] + tl*v_dir[y])             # <<<<<<<<<<<<<<
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":225
 *             temp_x = (v_pos[x] + tl*v_dir[x])
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \             # <<<<<<<<<<<<<<
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":226
 *             temp_y = (v_pos[y] + tl*v_dir[y])
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \             # <<<<<<<<<<<<<<
 *                (0.0 <= tl < intersect_t):
 ...
 */
      ...
      if (__pyx_t_3) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":227
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 *                (0.0 <= tl < intersect_t):             # <<<<<<<<<<<<<<
 *                 intersect_t = tl
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":228
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 *                (0.0 <= tl < intersect_t):
 *                 intersect_t = tl             # <<<<<<<<<<<<<<
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":229
 *                (0.0 <= tl < intersect_t):
 *                 intersect_t = tl
 *             temp_x = (v_pos[x] + tr*v_dir[x])             # <<<<<<<<<<<<<<
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":230
 *                 intersect_t = tl
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 *             temp_y = (v_pos[y] + tr*v_dir[y])             # <<<<<<<<<<<<<<
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":231
 *             temp_x = (v_pos[x] + tr*v_dir[x])
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \             # <<<<<<<<<<<<<<
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":232
 *             temp_y = (v_pos[y] + tr*v_dir[y])
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \             # <<<<<<<<<<<<<<
 *                (0.0 <= tr < intersect_t):
 ...
 */
      ...
      if (__pyx_t_2) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":233
 *             if (self.left_edge[x] <= temp_x <= self.right_edge[x]) and \
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 *                (0.0 <= tr < intersect_t):             # <<<<<<<<<<<<<<
 *                 intersect_t = tr
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":234
 *                (self.left_edge[y] <= temp_y <= self.right_edge[y]) and \
 *                (0.0 <= tr < intersect_t):
 *                 intersect_t = tr             # <<<<<<<<<<<<<<
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":235
 *                (0.0 <= tr < intersect_t):
 *                 intersect_t = tr
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \             # <<<<<<<<<<<<<<
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 ...
 */
  if (((__pyx_v_self->left_edge[0]) <= (__pyx_v_v_pos[0]))) {
    if (((__pyx_v_v_pos[0]) <= (__pyx_v_self->right_edge[0]))) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":236
 *                 intersect_t = tr
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \             # <<<<<<<<<<<<<<
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 ...
 */
      if (((__pyx_v_self->left_edge[1]) <= (__pyx_v_v_pos[1]))) {
        if (((__pyx_v_v_pos[1]) <= (__pyx_v_self->right_edge[1]))) {
          ...
          /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":237
 *         if self.left_edge[0] <= v_pos[0] and v_pos[0] <= self.right_edge[0] and \
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:             # <<<<<<<<<<<<<<
 *             intersect_t = 0.0
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":238
 *            self.left_edge[1] <= v_pos[1] and v_pos[1] <= self.right_edge[1] and \
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 *             intersect_t = 0.0             # <<<<<<<<<<<<<<
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":239
 *            self.left_edge[2] <= v_pos[2] and v_pos[2] <= self.right_edge[2]:
 *             intersect_t = 0.0
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):             # <<<<<<<<<<<<<<
 *             return 0
 ...
 */
  ...
  if (__pyx_t_3) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":240
 *             intersect_t = 0.0
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 *             return 0             # <<<<<<<<<<<<<<
 *         for i in range(3):
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":241
 *         if not ((0.0 <= intersect_t) and (intersect_t < 1.0)):
 *             return 0
 *         for i in range(3):             # <<<<<<<<<<<<<<
 *             cur_pos[i] =  v_pos[i] + intersect_t * v_dir[i]
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":242
 *             return 0
 *         for i in range(3):
 *             cur_pos[i] =  v_pos[i] + intersect_t * v_dir[i]             # <<<<<<<<<<<<<<
 *             cur_ind[i] = <int> floor((cur_pos[i] + 1e-8*self.dds[i] -
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":243
 *         for i in range(3):
 *             cur_pos[i] =  v_pos[i] + intersect_t * v_dir[i]
 *             cur_ind[i] = <int> floor((cur_pos[i] + 1e-8*self.dds[i] -             # <<<<<<<<<<<<<<
 *                                       self.left_edge[i])/self.dds[i])
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":245
 *             cur_ind[i] = <int> floor((cur_pos[i] + 1e-8*self.dds[i] -
 *                                       self.left_edge[i])/self.dds[i])
 *             if cur_ind[i] == self.dims[i] and v_dir[i] < 0:             # <<<<<<<<<<<<<<
 *                 cur_ind[i] = self.dims[i] - 1
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":246
 *                                       self.left_edge[i])/self.dds[i])
 *             if cur_ind[i] == self.dims[i] and v_dir[i] < 0:
 *                 cur_ind[i] = self.dims[i] - 1             # <<<<<<<<<<<<<<
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":247
 *             if cur_ind[i] == self.dims[i] and v_dir[i] < 0:
 *                 cur_ind[i] = self.dims[i] - 1
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:             # <<<<<<<<<<<<<<
 *                 return 0
 ...
 */
    ...
    if (__pyx_t_3) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":248
 *                 cur_ind[i] = self.dims[i] - 1
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 *                 return 0             # <<<<<<<<<<<<<<
 *         t = ceil(intersect_t / dt) * dt
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":249
 *             if cur_ind[i] < 0 or cur_ind[i] >= self.dims[i]:
 *                 return 0
 *         t = ceil(intersect_t / dt) * dt             # <<<<<<<<<<<<<<
 *         while 1:
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":250
 *                 return 0
 *         t = ceil(intersect_t / dt) * dt
 *         while 1:             # <<<<<<<<<<<<<<
 *             for i in range(3):
 ...
 */
  while (1) {
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":251
 *         t = ceil(intersect_t / dt) * dt
 *         while 1:
 *             for i in range(3):             # <<<<<<<<<<<<<<
 *                 cur_pos[i] = v_pos[i] + t*v_dir[i]
 ...
 */
    for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":252
 *         while 1:
 *             for i in range(3):
 *                 cur_pos[i] = v_pos[i] + t*v_dir[i]             # <<<<<<<<<<<<<<
 *                 cur_ind[i] = <int> floor((cur_pos[i] - self.left_edge[i])/self.dds[i])
 ...
 */
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":253
 *             for i in range(3):
 *                 cur_pos[i] = v_pos[i] + t*v_dir[i]
 *                 cur_ind[i] = <int> floor((cur_pos[i] - self.left_edge[i])/self.dds[i])             # <<<<<<<<<<<<<<
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":254
 *                 cur_pos[i] = v_pos[i] + t*v_dir[i]
 *                 cur_ind[i] = <int> floor((cur_pos[i] - self.left_edge[i])/self.dds[i])
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \             # <<<<<<<<<<<<<<
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 ...
 */
    ...
    if (!(!__pyx_t_3)) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":255
 *                 cur_ind[i] = <int> floor((cur_pos[i] - self.left_edge[i])/self.dds[i])
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \             # <<<<<<<<<<<<<<
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 ...
 */
      ...
      if (!(!__pyx_t_2)) {
        ...
        /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":256
 *             if (not (0 <= cur_ind[0] < self.dims[0])) or \
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 *                (not (0 <= cur_ind[2] < self.dims[2])):             # <<<<<<<<<<<<<<
 *                 break
 ...
 */
    ...
    if (__pyx_t_2) {
      ...
      /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":257
 *                (not (0 <= cur_ind[1] < self.dims[1])) or \
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 *                 break             # <<<<<<<<<<<<<<
 *             hit += 1
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":258
 *                (not (0 <= cur_ind[2] < self.dims[2])):
 *                 break
 *             hit += 1             # <<<<<<<<<<<<<<
 *             dv = fast_interpolate(self.left_edge, self.dds, self.dims,
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":260
 *             hit += 1
 *             dv = fast_interpolate(self.left_edge, self.dds, self.dims,
 *                                   cur_ind, cur_pos, self.data)             # <<<<<<<<<<<<<<
 *             # Do our transfer here
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":262
 *                                   cur_ind, cur_pos, self.data)
 *             # Do our transfer here
 *             eval_shells(nshells, dv, shells, rgba)             # <<<<<<<<<<<<<<
 *             t += dt
 ...
 */
    ...
    /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":263
 *             # Do our transfer here
 *             eval_shells(nshells, dv, shells, rgba)
 *             t += dt             # <<<<<<<<<<<<<<
 *         return hit
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":264
 *             eval_shells(nshells, dv, shells, rgba)
 *             t += dt
 *         return hit             # <<<<<<<<<<<<<<
 */
...
/* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":65
...
static int __pyx_pf_5numpy_7ndarray___getbuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info, int __pyx_v_flags) {
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":71
 *             # of flags
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":72
 *             cdef int copy_shape, i, ndim
 *             cdef int endian_detector = 1
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":74
 *             cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *             ndim = PyArray_NDIM(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":76
 *             ndim = PyArray_NDIM(self)
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 copy_shape = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":77
 * 
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 copy_shape = 1             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":79
 *                 copy_shape = 1
 *             else:
 *                 copy_shape = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":81
 *                 copy_shape = 0
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  if (((__pyx_v_flags & PyBUF_C_CONTIGUOUS) == PyBUF_C_CONTIGUOUS)) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":82
 * 
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError("ndarray is not C contiguous")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":83
 *             if ((flags & pybuf.PyBUF_C_CONTIGUOUS == pybuf.PyBUF_C_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_C_CONTIGUOUS)):
 *                 raise ValueError("ndarray is not C contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":85
 *                 raise ValueError("ndarray is not C contiguous")
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)             # <<<<<<<<<<<<<<
 ...
 */
  if (((__pyx_v_flags & PyBUF_F_CONTIGUOUS) == PyBUF_F_CONTIGUOUS)) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":86
 * 
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):             # <<<<<<<<<<<<<<
 *                 raise ValueError("ndarray is not Fortran contiguous")
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":87
 *             if ((flags & pybuf.PyBUF_F_CONTIGUOUS == pybuf.PyBUF_F_CONTIGUOUS)
 *                 and not PyArray_CHKFLAGS(self, NPY_F_CONTIGUOUS)):
 *                 raise ValueError("ndarray is not Fortran contiguous")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":89
 *                 raise ValueError("ndarray is not Fortran contiguous")
 * 
 *             info.buf = PyArray_DATA(self)             # <<<<<<<<<<<<<<
 *             info.ndim = ndim
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":90
 * 
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim             # <<<<<<<<<<<<<<
 *             if copy_shape:
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":91
 *             info.buf = PyArray_DATA(self)
 *             info.ndim = ndim
 *             if copy_shape:             # <<<<<<<<<<<<<<
 *                 # Allocate new buffer for strides and shape info. This is allocated
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":94
 *                 # Allocate new buffer for strides and shape info. This is allocated
 *                 # as one block, strides first.
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":95
 *                 # as one block, strides first.
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim             # <<<<<<<<<<<<<<
 *                 for i in range(ndim):
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":96
 *                 info.strides = <Py_ssize_t*>stdlib.malloc(sizeof(Py_ssize_t) * ndim * 2)
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):             # <<<<<<<<<<<<<<
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 ...
 */
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_v_ndim; __pyx_t_4+=1) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":97
 *                 info.shape = info.strides + ndim
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]             # <<<<<<<<<<<<<<
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":98
 *                 for i in range(ndim):
 *                     info.strides[i] = PyArray_STRIDES(self)[i]
 *                     info.shape[i] = PyArray_DIMS(self)[i]             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":100
 *                     info.shape[i] = PyArray_DIMS(self)[i]
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":101
 *             else:
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)             # <<<<<<<<<<<<<<
 *             info.suboffsets = NULL
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":102
 *                 info.strides = <Py_ssize_t*>PyArray_STRIDES(self)
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL             # <<<<<<<<<<<<<<
 *             info.itemsize = PyArray_ITEMSIZE(self)
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":103
 *                 info.shape = <Py_ssize_t*>PyArray_DIMS(self)
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)             # <<<<<<<<<<<<<<
 *             info.readonly = not PyArray_ISWRITEABLE(self)
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":104
 *             info.suboffsets = NULL
 *             info.itemsize = PyArray_ITEMSIZE(self)
 *             info.readonly = not PyArray_ISWRITEABLE(self)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":107
 * 
 *             cdef int t
 *             cdef char* f = NULL             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":108
 *             cdef int t
 *             cdef char* f = NULL
 *             cdef dtype descr = self.descr             # <<<<<<<<<<<<<<
 *             cdef list stack
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":112
 *             cdef int offset
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":114
 *             cdef bint hasfields = PyDataType_HASFIELDS(descr)
 * 
 *             if not hasfields and not copy_shape:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":116
 *             if not hasfields and not copy_shape:
 *                 # do not call releasebuffer
 *                 info.obj = None             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":119
 *             else:
 *                 # need to call releasebuffer
 *                 info.obj = self             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":121
 *                 info.obj = self
 * 
 *             if not hasfields:             # <<<<<<<<<<<<<<
 *                 t = descr.type_num
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":122
 * 
 *             if not hasfields:
 *                 t = descr.type_num             # <<<<<<<<<<<<<<
 *                 if ((descr.byteorder == '>' and little_endian) or
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":123
 *             if not hasfields:
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 *                     (descr.byteorder == '<' and not little_endian)):
 ...
 */
    ...
    if (!__pyx_t_1) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":124
 *                 t = descr.type_num
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *                     raise ValueError("Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":125
 *                 if ((descr.byteorder == '>' and little_endian) or
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError("Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *                 if   t == NPY_BYTE:        f = "b"
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":126
 *                     (descr.byteorder == '<' and not little_endian)):
 *                     raise ValueError("Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UBYTE:       f = "B"
 ...
 */
    switch (__pyx_v_t) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":127
 *                     raise ValueError("Non-native byte order not supported")
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_SHORT:       f = "h"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":128
 *                 if   t == NPY_BYTE:        f = "b"
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_USHORT:      f = "H"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":129
 *                 elif t == NPY_UBYTE:       f = "B"
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_INT:         f = "i"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":130
 *                 elif t == NPY_SHORT:       f = "h"
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_UINT:        f = "I"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":131
 *                 elif t == NPY_USHORT:      f = "H"
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONG:        f = "l"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":132
 *                 elif t == NPY_INT:         f = "i"
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONG:       f = "L"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":133
 *                 elif t == NPY_UINT:        f = "I"
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGLONG:    f = "q"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":134
 *                 elif t == NPY_LONG:        f = "l"
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":135
 *                 elif t == NPY_ULONG:       f = "L"
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_FLOAT:       f = "f"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":136
 *                 elif t == NPY_LONGLONG:    f = "q"
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_DOUBLE:      f = "d"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":137
 *                 elif t == NPY_ULONGLONG:   f = "Q"
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":138
 *                 elif t == NPY_FLOAT:       f = "f"
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":139
 *                 elif t == NPY_DOUBLE:      f = "d"
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":140
 *                 elif t == NPY_LONGDOUBLE:  f = "g"
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":141
 *                 elif t == NPY_CFLOAT:      f = "Zf"
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"             # <<<<<<<<<<<<<<
 *                 elif t == NPY_OBJECT:      f = "O"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":142
 *                 elif t == NPY_CDOUBLE:     f = "Zd"
 *                 elif t == NPY_CLONGDOUBLE: f = "Zg"
 *                 elif t == NPY_OBJECT:      f = "O"             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":144
 *                 elif t == NPY_OBJECT:      f = "O"
 *                 else:
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *                 info.format = f
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":145
 *                 else:
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f             # <<<<<<<<<<<<<<
 *                 return
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":146
 *                     raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *                 info.format = f
 *                 return             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":148
 *                 return
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":149
 *             else:
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment             # <<<<<<<<<<<<<<
 *                 offset = 0
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":150
 *                 info.format = <char*>stdlib.malloc(_buffer_format_string_len)
 *                 info.format[0] = '^' # Native data types, manual alignment
 *                 offset = 0             # <<<<<<<<<<<<<<
 *                 f = _util_dtypestring(descr, info.format + 1,
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":153
 *                 f = _util_dtypestring(descr, info.format + 1,
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":154
 *                                       info.format + _buffer_format_string_len,
 *                                       &offset)
 *                 f[0] = 0 # Terminate format string             # <<<<<<<<<<<<<<
 * 
...
/* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":156
 *                 f[0] = 0 # Terminate format string
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):             # <<<<<<<<<<<<<<
...
static void __pyx_pf_5numpy_7ndarray___releasebuffer__(PyObject *__pyx_v_self, Py_buffer *__pyx_v_info) {
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":157
 * 
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.format)
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":158
 *         def __releasebuffer__(ndarray self, Py_buffer* info):
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)             # <<<<<<<<<<<<<<
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":159
 *             if PyArray_HASFIELDS(self):
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):             # <<<<<<<<<<<<<<
 *                 stdlib.free(info.strides)
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":160
 *                 stdlib.free(info.format)
 *             if sizeof(npy_intp) != sizeof(Py_ssize_t):
 *                 stdlib.free(info.strides)             # <<<<<<<<<<<<<<
 *                 # info.shape was stored after info.strides in the same block
...
/* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":277
...
static INLINE char *__pyx_f_5numpy__util_dtypestring(PyArray_Descr *__pyx_v_descr, char *__pyx_v_f, char *__pyx_v_end, int *__pyx_v_offset) {
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":284
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":285
 *     cdef tuple i
 *     cdef int endian_detector = 1
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":287
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)
 * 
 *     for i in descr.fields.itervalues():             # <<<<<<<<<<<<<<
 *         child = i[0]
 ...
 */
  ...
  for (;;) {
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":288
 * 
 *     for i in descr.fields.itervalues():
 *         child = i[0]             # <<<<<<<<<<<<<<
 *         new_offset = i[1]
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":289
 *     for i in descr.fields.itervalues():
 *         child = i[0]
 *         new_offset = i[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":291
 *         new_offset = i[1]
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":292
 * 
 *         if (end - f) - (new_offset - offset[0]) < 15:
 *             raise RuntimeError("Format string allocated too short, see comment in numpy.pxd")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":294
 *             raise RuntimeError("Format string allocated too short, see comment in numpy.pxd")
 * 
 *         if ((child.byteorder == '>' and little_endian) or             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (!__pyx_t_6) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":295
 * 
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):             # <<<<<<<<<<<<<<
 *             raise ValueError("Non-native byte order not supported")
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":296
 *         if ((child.byteorder == '>' and little_endian) or
 *             (child.byteorder == '<' and not little_endian)):
 *             raise ValueError("Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *             # One could encode it in the format string and have Cython
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":306
 * 
 ...
 */
    while (1) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":307
 *         # Output padding bytes
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":308
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte
 *             f += 1             # <<<<<<<<<<<<<<
 *             offset[0] += 1
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":309
 *             f[0] = 120 # "x"; pad byte
 *             f += 1
 *             offset[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":311
 *             offset[0] += 1
 * 
 *         offset[0] += child.itemsize             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":313
 *         offset[0] += child.itemsize
 * 
 *         if not PyDataType_HASFIELDS(child):             # <<<<<<<<<<<<<<
 *             t = child.type_num
 ...
 */
    ...
    if (__pyx_t_8) {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":314
 * 
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num             # <<<<<<<<<<<<<<
 *             if end - f < 5:
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":315
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num
 *             if end - f < 5:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError("Format string allocated too short.")
 ...
 */
      ...
      if (__pyx_t_8) {
        ...
        /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":316
 *             t = child.type_num
 *             if end - f < 5:
 *                 raise RuntimeError("Format string allocated too short.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":319
 * 
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":320
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"             # <<<<<<<<<<<<<<
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":321
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"             # <<<<<<<<<<<<<<
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":322
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"             # <<<<<<<<<<<<<<
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":323
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"             # <<<<<<<<<<<<<<
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":324
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":325
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":326
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":327
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":328
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":329
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"             # <<<<<<<<<<<<<<
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":330
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":331
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"             # <<<<<<<<<<<<<<
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":332
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf             # <<<<<<<<<<<<<<
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":333
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd             # <<<<<<<<<<<<<<
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":334
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg             # <<<<<<<<<<<<<<
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":335
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":337
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 *             else:
 *                 raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":338
 *             else:
 *                 raise ValueError("unknown dtype code in numpy.pxd (%d)" % t)
 *             f += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":342
 *             # Cython ignores struct boundary information ("T{...}"),
 *             # so don't output it
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/numpy.pxd":343
 *             # so don't output it
 *             f = _util_dtypestring(child, f, end, offset)
 *     return f             # <<<<<<<<<<<<<<
 * 
...
#endif
{
  ...
  *(void(**)(void))&__pyx_vtable_2yt_10extensions_16volume_rendering_16VolumeIntegrator_PartitionedGrid.sample_ray = (void(*)(void))__pyx_f_2yt_10extensions_16volume_rendering_16VolumeIntegrator_15PartitionedGrid_sample_ray;
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":26
 * """
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "/yt/yt/extensions/volume_rendering/VolumeIntegrator.pyx":81
 *                          np.ndarray[np.float64_t, ndim=2] shells,
 ...
 */
  ...
  /* "lib/python2.6/site-packages/Cython-0.11.2-py2.6-linux-x86_64.egg/Cython/Includes/stdlib.pxd":2
 * 
