################################################## 
# deliverator_services.py 
# generated by ZSI.generate.wsdl2python
##################################################


from deliverator_services_types import *
...
class DeliveratorServerLocator:
    deliverator_porttype_address = "http://localhost:8080/DeliveratorMethods"
    def getdeliverator_porttypeAddress(self):
        return DeliveratorServerLocator.deliverator_porttype_address
    def getdeliverator_porttype(self, url=None, **kw):
        return deliverator_bindingSOAP(url or DeliveratorServerLocator.deliverator_porttype_address, **kw)

# Methods
class deliverator_bindingSOAP:
