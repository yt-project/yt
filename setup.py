...
lib_exts = ["yt/geometry/*.pyx", "yt/utilities/cython_fortran_utils.pyx",
...
lib_exts += ["yt/utilities/lib/{}.pyx".format(_) for _ in [
    ...
    "write_array", "ragged_arrays", "line_integral_convolution",
    "bitarray", "fnv_hash", "mesh_triangulation", "particle_kdtree_tools",
    "primitives", "cosmology_time", "element_mappings", "alt_ray_tracers",
    "bounded_priority_queue", "autogenerated_element_samplers",
    "geometry_utils", "bounding_volume_hierarchy", "contour_finding",
    "marching_cubes", "cyoctree", "grid_traversal", "ewah_bool_wrap",
    "partitioned_grid", "misc_utilities"
]]
