...
.. code-block:: pycon
    ...
    as of yt v4.0 and will be removed in yt v4.1. 
...
In this case, the log message reports to the user what field they should use:
...
.. code-block:: pycon
    ...
    ('gas', 'kinetic_energy') is deprecated as of yt v4.0 and will be removed
    in yt v4.1. Use ('gas', 'kinetic_energy_density') instead.
